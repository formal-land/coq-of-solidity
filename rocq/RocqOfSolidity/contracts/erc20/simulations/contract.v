...
Require Import contracts.erc20.contract.
...
Definition get_memory_end_beginning (sender : Address.t) (payload : Payload.t) : U256.t * U256.t :=
  ...
  | Payload.TransferFrom from _ _ => (sender, keccak256_tuple2 from 1)
  | Payload.IncreaseAllowance to _ => (to, keccak256_tuple2 sender 1)
  | Payload.DecreaseAllowance to _ => (to, keccak256_tuple2 sender 1)
