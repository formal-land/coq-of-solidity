...
Module C.
  ...
  Module deployed.
                          ...
                          do! ltac:(M.monadic (
                            M.declare (|
                              ...
                              Some (M.call_function (|
                                "datasize",
                                [
                                  [Literal.string 0x415f313700000000000000000000000000000000000000000000000000000000]
                                ]
                              |))
                            |)
                          )) in
    ...
    Module A.
      Definition code : Code.t := {|
        Code.name := "A_17";
        Code.hex_name := 0x415f313700000000000000000000000000000000000000000000000000000000;
        Code.functions :=
          [
                ...
                do! ltac:(M.monadic (
                  M.declare (|
                    ...
                    Some (M.call_function (|
                      "datasize",
                      [
                        [Literal.string 0x415f31375f6465706c6f79656400000000000000000000000000000000000000]
                      ]
                    |))
                  |)
                )) in
      ...
      Module deployed.
        Definition code : Code.t := {|
          Code.name := "A_17_deployed";
          Code.hex_name := 0x415f31375f6465706c6f79656400000000000000000000000000000000000000;
          Code.functions :=
            [
