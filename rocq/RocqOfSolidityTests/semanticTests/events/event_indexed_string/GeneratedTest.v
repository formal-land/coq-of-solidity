...
Require semanticTests.events.event_indexed_string.C.

Definition constructor_code : Code.t :=
  semanticTests.events.event_indexed_string.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_indexed_string.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_indexed_string.C.codes.
