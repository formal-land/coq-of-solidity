...
Require semanticTests.events.event_static_calldata_uint_array_and_dynamic_array.C.

Definition constructor_code : Code.t :=
  semanticTests.events.event_static_calldata_uint_array_and_dynamic_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_static_calldata_uint_array_and_dynamic_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_static_calldata_uint_array_and_dynamic_array.C.codes.
