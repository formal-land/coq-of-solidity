...
Require semanticTests.events.event_string.C.

Definition constructor_code : Code.t :=
  semanticTests.events.event_string.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_string.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_string.C.codes.
