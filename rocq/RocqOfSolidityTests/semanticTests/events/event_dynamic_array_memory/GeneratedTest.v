...
Require semanticTests.events.event_dynamic_array_memory.C.

Definition constructor_code : Code.t :=
  semanticTests.events.event_dynamic_array_memory.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_dynamic_array_memory.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_dynamic_array_memory.C.codes.
