...
Require semanticTests.events.event_indexed_mixed.C.

Definition constructor_code : Code.t :=
  semanticTests.events.event_indexed_mixed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_indexed_mixed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_indexed_mixed.C.codes.
