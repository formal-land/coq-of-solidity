...
Require semanticTests.events.event_access_through_base_name_emit.A.
Require semanticTests.events.event_access_through_base_name_emit.B.

Definition constructor_code : Code.t :=
  semanticTests.events.event_access_through_base_name_emit.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_access_through_base_name_emit.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_access_through_base_name_emit.B.codes.
