...
Require semanticTests.events.event_selector.B.
Require semanticTests.events.event_selector.C.
Require semanticTests.events.event_selector.D.
Require semanticTests.events.event_selector.I.
Require semanticTests.events.event_selector.L.
Require semanticTests.events.event_selector.S.
Require semanticTests.events.event_selector.T.

Definition constructor_code : Code.t :=
  semanticTests.events.event_selector.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_selector.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_selector.C.codes.
