...
Require semanticTests.events.event_anonymous_with_signature_collision2.ClientReceipt.

Definition constructor_code : Code.t :=
  semanticTests.events.event_anonymous_with_signature_collision2.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_anonymous_with_signature_collision2.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_anonymous_with_signature_collision2.ClientReceipt.codes.
