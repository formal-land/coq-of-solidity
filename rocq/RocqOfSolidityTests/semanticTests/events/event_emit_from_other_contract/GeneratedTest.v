...
Require semanticTests.events.event_emit_from_other_contract.C.
Require semanticTests.events.event_emit_from_other_contract.D.

Definition constructor_code : Code.t :=
  semanticTests.events.event_emit_from_other_contract.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_emit_from_other_contract.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_emit_from_other_contract.C.codes.
