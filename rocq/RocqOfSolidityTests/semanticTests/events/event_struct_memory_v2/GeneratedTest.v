...
Require semanticTests.events.event_struct_memory_v2.C.

Definition constructor_code : Code.t :=
  semanticTests.events.event_struct_memory_v2.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_struct_memory_v2.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_struct_memory_v2.C.codes.
