...
Require semanticTests.events.event_dynamic_array_storage.C.

Definition constructor_code : Code.t :=
  semanticTests.events.event_dynamic_array_storage.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_dynamic_array_storage.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_dynamic_array_storage.C.codes.
