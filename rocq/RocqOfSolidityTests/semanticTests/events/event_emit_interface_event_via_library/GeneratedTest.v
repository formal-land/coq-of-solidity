...
Require semanticTests.events.event_emit_interface_event_via_library.C.
Require semanticTests.events.event_emit_interface_event_via_library.I.
Require semanticTests.events.event_emit_interface_event_via_library.L.

Definition constructor_code : Code.t :=
  semanticTests.events.event_emit_interface_event_via_library.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_emit_interface_event_via_library.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_emit_interface_event_via_library.C.codes.
