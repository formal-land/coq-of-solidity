...
Require semanticTests.events.event_indexed_function.C.

Definition constructor_code : Code.t :=
  semanticTests.events.event_indexed_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_indexed_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_indexed_function.C.codes.
