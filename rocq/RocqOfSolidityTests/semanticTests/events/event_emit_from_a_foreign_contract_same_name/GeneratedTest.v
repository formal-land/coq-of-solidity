...
Require semanticTests.events.event_emit_from_a_foreign_contract_same_name.C.
Require semanticTests.events.event_emit_from_a_foreign_contract_same_name.D.

Definition constructor_code : Code.t :=
  semanticTests.events.event_emit_from_a_foreign_contract_same_name.D.D.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_emit_from_a_foreign_contract_same_name.D.D.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_emit_from_a_foreign_contract_same_name.D.codes.
