...
Require semanticTests.events.event_constructor.ClientReceipt.

Definition constructor_code : Code.t :=
  semanticTests.events.event_constructor.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_constructor.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_constructor.ClientReceipt.codes.
