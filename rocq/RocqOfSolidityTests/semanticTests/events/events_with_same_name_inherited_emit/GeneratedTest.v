...
Require semanticTests.events.events_with_same_name_inherited_emit.A.
Require semanticTests.events.events_with_same_name_inherited_emit.B.
Require semanticTests.events.events_with_same_name_inherited_emit.ClientReceipt.

Definition constructor_code : Code.t :=
  semanticTests.events.events_with_same_name_inherited_emit.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  semanticTests.events.events_with_same_name_inherited_emit.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.events_with_same_name_inherited_emit.ClientReceipt.codes.
