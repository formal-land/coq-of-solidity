...
Require semanticTests.events.event_really_really_lots_of_data_from_storage.ClientReceipt.

Definition constructor_code : Code.t :=
  semanticTests.events.event_really_really_lots_of_data_from_storage.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_really_really_lots_of_data_from_storage.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_really_really_lots_of_data_from_storage.ClientReceipt.codes.
