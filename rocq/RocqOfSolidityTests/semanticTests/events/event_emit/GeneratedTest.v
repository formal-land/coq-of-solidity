...
Require semanticTests.events.event_emit.ClientReceipt.

Definition constructor_code : Code.t :=
  semanticTests.events.event_emit.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  semanticTests.events.event_emit.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list Code.t :=
  semanticTests.events.event_emit.ClientReceipt.codes.
