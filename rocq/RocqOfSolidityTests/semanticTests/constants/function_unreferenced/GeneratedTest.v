...
Require semanticTests.constants.function_unreferenced.B.
Require semanticTests.constants.function_unreferenced.C.

Definition constructor_code : Code.t :=
  semanticTests.constants.function_unreferenced.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.constants.function_unreferenced.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constants.function_unreferenced.C.codes.
