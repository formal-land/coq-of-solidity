...
Require semanticTests.constants.asm_address_constant_regression.C.

Definition constructor_code : Code.t :=
  semanticTests.constants.asm_address_constant_regression.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.constants.asm_address_constant_regression.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constants.asm_address_constant_regression.C.codes.
