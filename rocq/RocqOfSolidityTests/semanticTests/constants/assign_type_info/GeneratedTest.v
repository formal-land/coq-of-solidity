...
Require semanticTests.constants.assign_type_info.A.
Require semanticTests.constants.assign_type_info.B.

Definition constructor_code : Code.t :=
  semanticTests.constants.assign_type_info.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.constants.assign_type_info.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constants.assign_type_info.B.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "73c60a6b";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
