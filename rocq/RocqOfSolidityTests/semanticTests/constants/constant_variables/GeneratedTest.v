...
Require semanticTests.constants.constant_variables.Foo.

Definition constructor_code : Code.t :=
  semanticTests.constants.constant_variables.Foo.Foo.code.

Definition deployed_code : Code.t :=
  semanticTests.constants.constant_variables.Foo.Foo.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constants.constant_variables.Foo.codes.
