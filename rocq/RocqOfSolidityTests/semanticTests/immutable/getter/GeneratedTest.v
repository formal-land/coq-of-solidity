...
Require semanticTests.immutable.getter.C.

Definition constructor_code : Code.t :=
  semanticTests.immutable.getter.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.immutable.getter.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.immutable.getter.C.codes.
