...
Require semanticTests.immutable.delete.C.

Definition constructor_code : Code.t :=
  semanticTests.immutable.delete.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.immutable.delete.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.immutable.delete.C.codes.
