...
Require semanticTests.immutable.assign_from_immutables.C.

Definition constructor_code : Code.t :=
  semanticTests.immutable.assign_from_immutables.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.immutable.assign_from_immutables.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.immutable.assign_from_immutables.C.codes.
