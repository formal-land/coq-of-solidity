...
Require semanticTests.immutable.uninitialized.C.

Definition constructor_code : Code.t :=
  semanticTests.immutable.uninitialized.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.immutable.uninitialized.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.immutable.uninitialized.C.codes.
