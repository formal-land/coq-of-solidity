...
Require semanticTests.immutable.multiple_initializations.A.
Require semanticTests.immutable.multiple_initializations.B.
Require semanticTests.immutable.multiple_initializations.C.

Definition constructor_code : Code.t :=
  semanticTests.immutable.multiple_initializations.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.immutable.multiple_initializations.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.immutable.multiple_initializations.C.codes.
