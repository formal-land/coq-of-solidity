...
Require semanticTests.immutable.immutable_signed.C.

Definition constructor_code : Code.t :=
  semanticTests.immutable.immutable_signed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.immutable.immutable_signed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.immutable.immutable_signed.C.codes.
