...
Require semanticTests.immutable.stub.C.

Definition constructor_code : Code.t :=
  semanticTests.immutable.stub.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.immutable.stub.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.immutable.stub.C.codes.
