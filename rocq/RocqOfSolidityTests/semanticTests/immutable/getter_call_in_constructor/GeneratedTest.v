...
Require semanticTests.immutable.getter_call_in_constructor.A.
Require semanticTests.immutable.getter_call_in_constructor.C.

Definition constructor_code : Code.t :=
  semanticTests.immutable.getter_call_in_constructor.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.immutable.getter_call_in_constructor.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.immutable.getter_call_in_constructor.C.codes.
