...
Require semanticTests.state_variables_init_order.A.
Require semanticTests.state_variables_init_order.B.

Definition constructor_code : Code.t :=
  semanticTests.state_variables_init_order.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.state_variables_init_order.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state_variables_init_order.B.codes.
