...
Require semanticTests.functionCall.conditional_with_arguments.C.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.conditional_with_arguments.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.conditional_with_arguments.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.conditional_with_arguments.C.codes.
