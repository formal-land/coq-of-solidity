...
Require semanticTests.functionCall.call_options_overload.C.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.call_options_overload.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.call_options_overload.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.call_options_overload.C.codes.
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "28b5e32b";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
...
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "3d79d1c8";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
