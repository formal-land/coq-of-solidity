...
Require semanticTests.functionCall.disordered_named_args.test.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.disordered_named_args.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.disordered_named_args.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.disordered_named_args.test.codes.
