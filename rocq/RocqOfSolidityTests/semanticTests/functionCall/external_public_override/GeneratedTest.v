...
Require semanticTests.functionCall.external_public_override.A.
Require semanticTests.functionCall.external_public_override.B.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.external_public_override.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.external_public_override.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.external_public_override.B.codes.
