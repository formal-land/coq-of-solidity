...
Require semanticTests.functionCall.calldata_and_memory_arguments.C.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.calldata_and_memory_arguments.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.calldata_and_memory_arguments.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.calldata_and_memory_arguments.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
