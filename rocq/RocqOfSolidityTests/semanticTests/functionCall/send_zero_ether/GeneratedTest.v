...
Require semanticTests.functionCall.send_zero_ether.Main.
Require semanticTests.functionCall.send_zero_ether.Receiver.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.send_zero_ether.Main.Main.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.send_zero_ether.Main.Main.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.send_zero_ether.Main.codes.
