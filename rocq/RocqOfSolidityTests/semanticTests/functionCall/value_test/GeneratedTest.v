...
Require semanticTests.functionCall.value_test.C.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.value_test.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.value_test.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.value_test.C.codes.
