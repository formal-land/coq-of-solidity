...
Require semanticTests.functionCall.call_attached_library_function_on_function.C.
Require semanticTests.functionCall.call_attached_library_function_on_function.L.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.call_attached_library_function_on_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.call_attached_library_function_on_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.call_attached_library_function_on_function.C.codes.
