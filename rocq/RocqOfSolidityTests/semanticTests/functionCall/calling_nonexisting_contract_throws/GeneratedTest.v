...
Require semanticTests.functionCall.calling_nonexisting_contract_throws.C.
Require semanticTests.functionCall.calling_nonexisting_contract_throws.D.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.calling_nonexisting_contract_throws.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.calling_nonexisting_contract_throws.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.calling_nonexisting_contract_throws.C.codes.
