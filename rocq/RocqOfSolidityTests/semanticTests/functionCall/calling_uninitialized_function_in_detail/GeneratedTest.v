...
Require semanticTests.functionCall.calling_uninitialized_function_in_detail.C.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.calling_uninitialized_function_in_detail.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.calling_uninitialized_function_in_detail.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.calling_uninitialized_function_in_detail.C.codes.
