...
Require semanticTests.functionCall.precompile_extcodesize_check.C.
Require semanticTests.functionCall.precompile_extcodesize_check.Identity.
Require semanticTests.functionCall.precompile_extcodesize_check.ReturnMoreData.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.precompile_extcodesize_check.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.precompile_extcodesize_check.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.precompile_extcodesize_check.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "1e48d01e";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "a935c0d6";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "c76596d400000000000000000000000000000000000000000000000000000000".
...
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "9d349b9b";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
