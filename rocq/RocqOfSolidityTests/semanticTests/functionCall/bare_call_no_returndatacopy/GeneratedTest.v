...
Require semanticTests.functionCall.bare_call_no_returndatacopy.C.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.bare_call_no_returndatacopy.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.bare_call_no_returndatacopy.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.bare_call_no_returndatacopy.C.codes.
