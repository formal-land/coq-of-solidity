...
Require semanticTests.functionCall.call_function_returning_function.test.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.call_function_returning_function.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.call_function_returning_function.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.call_function_returning_function.test.codes.
