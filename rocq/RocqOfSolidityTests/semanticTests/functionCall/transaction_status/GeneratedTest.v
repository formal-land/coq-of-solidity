...
Require semanticTests.functionCall.transaction_status.test.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.transaction_status.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.transaction_status.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.transaction_status.test.codes.
