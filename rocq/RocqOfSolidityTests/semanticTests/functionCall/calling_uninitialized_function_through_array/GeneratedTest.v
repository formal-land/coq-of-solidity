...
Require semanticTests.functionCall.calling_uninitialized_function_through_array.C.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.calling_uninitialized_function_through_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.calling_uninitialized_function_through_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.calling_uninitialized_function_through_array.C.codes.
