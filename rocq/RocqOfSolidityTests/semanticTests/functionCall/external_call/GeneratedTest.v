...
Require semanticTests.functionCall.external_call.C.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.external_call.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.external_call.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.external_call.C.codes.
