...
Require semanticTests.functionCall.external_call_at_construction_time.C.
Require semanticTests.functionCall.external_call_at_construction_time.T.
Require semanticTests.functionCall.external_call_at_construction_time.U.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.external_call_at_construction_time.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.external_call_at_construction_time.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.external_call_at_construction_time.C.codes.
