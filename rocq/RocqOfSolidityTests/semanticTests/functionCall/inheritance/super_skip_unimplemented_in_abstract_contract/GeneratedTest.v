...
Require semanticTests.functionCall.inheritance.super_skip_unimplemented_in_abstract_contract.A.
Require semanticTests.functionCall.inheritance.super_skip_unimplemented_in_abstract_contract.B.
Require semanticTests.functionCall.inheritance.super_skip_unimplemented_in_abstract_contract.I.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.inheritance.super_skip_unimplemented_in_abstract_contract.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.inheritance.super_skip_unimplemented_in_abstract_contract.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.inheritance.super_skip_unimplemented_in_abstract_contract.B.codes.
