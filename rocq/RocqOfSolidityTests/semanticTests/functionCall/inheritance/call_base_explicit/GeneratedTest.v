...
Require semanticTests.functionCall.inheritance.call_base_explicit.Base.
Require semanticTests.functionCall.inheritance.call_base_explicit.Child.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.inheritance.call_base_explicit.Child.Child.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.inheritance.call_base_explicit.Child.Child.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.inheritance.call_base_explicit.Child.codes.
