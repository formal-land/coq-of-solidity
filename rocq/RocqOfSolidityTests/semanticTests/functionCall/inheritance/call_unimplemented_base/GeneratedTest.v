...
Require semanticTests.functionCall.inheritance.call_unimplemented_base.C.
Require semanticTests.functionCall.inheritance.call_unimplemented_base.I.
Require semanticTests.functionCall.inheritance.call_unimplemented_base.J.
Require semanticTests.functionCall.inheritance.call_unimplemented_base.V.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.inheritance.call_unimplemented_base.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.inheritance.call_unimplemented_base.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.inheritance.call_unimplemented_base.C.codes.
