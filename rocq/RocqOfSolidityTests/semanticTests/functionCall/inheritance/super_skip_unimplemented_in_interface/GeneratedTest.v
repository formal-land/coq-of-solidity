...
Require semanticTests.functionCall.inheritance.super_skip_unimplemented_in_interface.A.
Require semanticTests.functionCall.inheritance.super_skip_unimplemented_in_interface.B.
Require semanticTests.functionCall.inheritance.super_skip_unimplemented_in_interface.I.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.inheritance.super_skip_unimplemented_in_interface.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.inheritance.super_skip_unimplemented_in_interface.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.inheritance.super_skip_unimplemented_in_interface.B.codes.
