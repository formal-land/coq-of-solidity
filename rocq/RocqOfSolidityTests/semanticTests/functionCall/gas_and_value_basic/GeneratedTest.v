...
Require semanticTests.functionCall.gas_and_value_basic.helper.
Require semanticTests.functionCall.gas_and_value_basic.test.

Definition constructor_code : Code.t :=
  semanticTests.functionCall.gas_and_value_basic.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.functionCall.gas_and_value_basic.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionCall.gas_and_value_basic.test.codes.
