...
Require semanticTests.arithmetics.signed_mod.C.

Definition constructor_code : Code.t :=
  semanticTests.arithmetics.signed_mod.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.arithmetics.signed_mod.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.arithmetics.signed_mod.C.codes.
