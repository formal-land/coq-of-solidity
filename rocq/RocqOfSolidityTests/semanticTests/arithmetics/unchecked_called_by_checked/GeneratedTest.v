...
Require semanticTests.arithmetics.unchecked_called_by_checked.C.

Definition constructor_code : Code.t :=
  semanticTests.arithmetics.unchecked_called_by_checked.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.arithmetics.unchecked_called_by_checked.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.arithmetics.unchecked_called_by_checked.C.codes.
