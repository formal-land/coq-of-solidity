...
Require semanticTests.arithmetics.addmod_mulmod.C.

Definition constructor_code : Code.t :=
  semanticTests.arithmetics.addmod_mulmod.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.arithmetics.addmod_mulmod.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.arithmetics.addmod_mulmod.C.codes.
