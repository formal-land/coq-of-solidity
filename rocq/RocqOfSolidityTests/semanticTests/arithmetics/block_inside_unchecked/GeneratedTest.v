...
Require semanticTests.arithmetics.block_inside_unchecked.C.

Definition constructor_code : Code.t :=
  semanticTests.arithmetics.block_inside_unchecked.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.arithmetics.block_inside_unchecked.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.arithmetics.block_inside_unchecked.C.codes.
