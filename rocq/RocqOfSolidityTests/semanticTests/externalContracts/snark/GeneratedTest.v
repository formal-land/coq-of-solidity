...
Require semanticTests.externalContracts.snark.Pairing.
Require semanticTests.externalContracts.snark.Test.

Definition constructor_code : Code.t :=
  semanticTests.externalContracts.snark.Test.Test.code.

Definition deployed_code : Code.t :=
  semanticTests.externalContracts.snark.Test.Test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.externalContracts.snark.Test.codes.
...
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "a8aa1b31";
    Environment.address := 0xe1e163b29f5bccb3764b5534ce0e2c02bd4fe650;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step4.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "6dae022f";
    Environment.address := 0xe1e163b29f5bccb3764b5534ce0e2c02bd4fe650;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
