...
Module Test.
  Definition code : Code.t := {|
    Code.name := "Test_1676";
    Code.hex_name := 0x546573745f313637360000000000000000000000000000000000000000000000;
    Code.functions :=
      [
            ...
            do! ltac:(M.monadic (
              M.declare (|
                ...
                Some (M.call_function (|
                  "datasize",
                  [
                    [Literal.string 0x546573745f313637365f6465706c6f7965640000000000000000000000000000]
                  ]
                |))
              |)
            )) in
  ...
  Module deployed.
    Definition code : Code.t := {|
      Code.name := "Test_1676_deployed";
      Code.hex_name := 0x546573745f313637365f6465706c6f7965640000000000000000000000000000;
      Code.functions :=
        [
          Code.Function.make (
            "finalize_allocation_6762",
            ["memPtr"],
            [],
            M.scope (
              do! ltac:(M.monadic (
          ...
          Code.Function.make (
            "memory_array_index_access_uint256_dyn_6783",
            ["baseRef"],
            ["addr"],
            M.scope (
              do! ltac:(M.monadic (
          ...
          Code.Function.make (
            "memory_array_index_access_t_array_t_uint256_dyn_memory_ptr",
            ["baseRef"],
            ["addr"],
            M.scope (
              do! ltac:(M.monadic (
          ...
          Code.Function.make (
            "memory_array_index_access_t_uint256_dyn_memory_ptr",
            ["baseRef"],
            ["addr"],
            M.scope (
              do! ltac:(M.monadic (
          ...
          Code.Function.make (
            "memory_array_index_access_uint256_dyn_6786",
            ["baseRef"],
            ["addr"],
            M.scope (
              do! ltac:(M.monadic (
          ...
          Code.Function.make (
            "memory_array_index_access_uint256_dyn_6787",
            ["baseRef"],
            ["addr"],
            M.scope (
              do! ltac:(M.monadic (
          ...
          Code.Function.make (
            "memory_array_index_access_t_array_t_uint256_dyn",
            ["baseRef"],
            ["addr"],
            M.scope (
              do! ltac:(M.monadic (
          ...
          Code.Function.make (
            "memory_array_index_access_t_uint256_dyn",
            ["baseRef"],
            ["addr"],
            M.scope (
              do! ltac:(M.monadic (
          ...
          Code.Function.make (
            "memory_array_index_access_uint256_dyn_memory_ptr",
            ["baseRef"],
            ["addr"],
            M.scope (
              do! ltac:(M.monadic (
          ...
          Code.Function.make (
            "memory_array_index_access_array_uint256_dyn_memory_ptr",
            ["baseRef"],
            ["addr"],
            M.scope (
              do! ltac:(M.monadic (
            ...
            M.scope (
              ...
              do! ltac:(M.monadic (
                M.assign (|
                  ["var_r_mpos"],
                  Some (M.call_function (|
                    "abi_decode_struct_G1Point_fromMemory",
                    [
                      M.call_function (|
                        "add",
                        [
                    ...
                    [
                      M.call_function (|
                        ...
                        [
                          M.get_var (| "_286_mpos" |);
                          M.get_var (| "_289_mpos" |);
                          M.get_var (| "expr_1447_mpos" |);
                          M.get_var (| "_299_mpos" |);
                          M.get_var (| "expr_1454_mpos" |);
                          M.call_function (|
                            "mload",
                            [
                              M.get_var (| "_6" |)
                    ...
                    [
                      M.call_function (|
                        ...
                        [
                          ...
                          M.get_var (| "_312_mpos" |);
                          M.get_var (| "expr_1476_mpos" |);
                          M.get_var (| "_318_mpos" |);
                          M.get_var (| "expr_1483_mpos" |);
                          M.call_function (|
                            "fun_P2",
                            []
                          |)
                      ...
                      M.call_function (|
                        ...
                        [
                          M.call_function (|
                            "add",
                            [
                              M.get_var (| "expr_422_component_2_mpos" |);
                              M.call_function (|
                                "mload",
                                [
                                  M.get_var (| "expr_422_component_2_mpos" |)
          ...
          Code.Function.make (
            "fun_pairingProd2",
            ["var_a1_mpos"; "var_a2_443_mpos"; "var_b1_446_mpos"; "var_b2_449_mpos"],
            ["var"],
            M.scope (
              do! ltac:(M.monadic (
                M.declare (|
                  ...
                  M.call_function (|
                    ...
                    [
                      M.call_function (|
                        "memory_array_index_access_uint256_dyn_6783",
                        [
                          M.get_var (| "expr_476_mpos" |)
                        ]
                      |);
                      M.get_var (| "var_a2_443_mpos" |)
                    ]
                  |)
                |)
              )) in
          ...
          Code.Function.make (
            "fun_pairingProd3",
            ["var_a1_511_mpos"; "var_a2_mpos"; "var_b1_mpos"; "var_b2_mpos"; "var_c1_mpos"; "var_c2_mpos"],
            ["var"],
            M.scope (
              do! ltac:(M.monadic (
                M.declare (|
