...
Require semanticTests.structs.struct_delete_storage.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.struct_delete_storage.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.struct_delete_storage.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.struct_delete_storage.C.codes.
