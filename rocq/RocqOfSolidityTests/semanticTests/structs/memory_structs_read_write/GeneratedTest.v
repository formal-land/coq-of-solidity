...
Require semanticTests.structs.memory_structs_read_write.Test.

Definition constructor_code : Code.t :=
  semanticTests.structs.memory_structs_read_write.Test.Test.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.memory_structs_read_write.Test.Test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.memory_structs_read_write.Test.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "b5d11e99";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "5a61549b";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "f4eaeb4e";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
