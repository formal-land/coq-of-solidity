...
Require semanticTests.structs.copy_struct_with_nested_array_from_storage_to_storage.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.copy_struct_with_nested_array_from_storage_to_storage.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.copy_struct_with_nested_array_from_storage_to_storage.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.copy_struct_with_nested_array_from_storage_to_storage.C.codes.
