...
Require semanticTests.structs.packed_storage_structs_delete.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.packed_storage_structs_delete.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.packed_storage_structs_delete.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.packed_storage_structs_delete.C.codes.
