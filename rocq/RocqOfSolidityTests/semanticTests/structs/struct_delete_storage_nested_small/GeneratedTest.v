...
Require semanticTests.structs.struct_delete_storage_nested_small.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.struct_delete_storage_nested_small.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.struct_delete_storage_nested_small.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.struct_delete_storage_nested_small.C.codes.
