...
Require semanticTests.structs.lone_struct_array_type.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.lone_struct_array_type.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.lone_struct_array_type.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.lone_struct_array_type.C.codes.
