...
Require semanticTests.structs.struct_delete_storage_with_array.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.struct_delete_storage_with_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.struct_delete_storage_with_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.struct_delete_storage_with_array.C.codes.
