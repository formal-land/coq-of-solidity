...
Require semanticTests.structs.struct_storage_to_mapping.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.struct_storage_to_mapping.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.struct_storage_to_mapping.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.struct_storage_to_mapping.C.codes.
