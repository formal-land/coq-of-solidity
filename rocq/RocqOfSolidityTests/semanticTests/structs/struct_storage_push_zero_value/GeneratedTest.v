...
Require semanticTests.structs.struct_storage_push_zero_value.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.struct_storage_push_zero_value.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.struct_storage_push_zero_value.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.struct_storage_push_zero_value.C.codes.
