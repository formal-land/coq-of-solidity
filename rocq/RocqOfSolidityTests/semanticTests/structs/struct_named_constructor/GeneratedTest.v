...
Require semanticTests.structs.struct_named_constructor.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.struct_named_constructor.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.struct_named_constructor.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.struct_named_constructor.C.codes.
