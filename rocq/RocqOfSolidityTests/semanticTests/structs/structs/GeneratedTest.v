...
Require semanticTests.structs.structs.test.

Definition constructor_code : Code.t :=
  semanticTests.structs.structs.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.structs.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.structs.test.codes.
