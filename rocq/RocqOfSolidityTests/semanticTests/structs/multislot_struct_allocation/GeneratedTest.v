...
Require semanticTests.structs.multislot_struct_allocation.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.multislot_struct_allocation.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.multislot_struct_allocation.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.multislot_struct_allocation.C.codes.
