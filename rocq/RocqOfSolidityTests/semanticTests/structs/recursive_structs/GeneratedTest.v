...
Require semanticTests.structs.recursive_structs.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.recursive_structs.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.recursive_structs.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.recursive_structs.C.codes.
