...
Require semanticTests.structs.copy_from_mapping.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.copy_from_mapping.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.copy_from_mapping.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.copy_from_mapping.C.codes.
