...
Require semanticTests.structs.struct_reference.test.

Definition constructor_code : Code.t :=
  semanticTests.structs.struct_reference.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.struct_reference.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.struct_reference.test.codes.
