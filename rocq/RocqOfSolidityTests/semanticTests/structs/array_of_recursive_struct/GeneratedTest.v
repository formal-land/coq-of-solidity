...
Require semanticTests.structs.array_of_recursive_struct.Test.

Definition constructor_code : Code.t :=
  semanticTests.structs.array_of_recursive_struct.Test.Test.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.array_of_recursive_struct.Test.Test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.array_of_recursive_struct.Test.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "bfa814b5";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
