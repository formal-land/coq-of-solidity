...
Require semanticTests.structs.struct_storage_to_memory.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.struct_storage_to_memory.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.struct_storage_to_memory.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.struct_storage_to_memory.C.codes.
