...
Require semanticTests.structs.calldata.calldata_struct_and_ints.C.

Definition constructor_code : Code.t :=
  semanticTests.structs.calldata.calldata_struct_and_ints.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.calldata.calldata_struct_and_ints.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.calldata.calldata_struct_and_ints.C.codes.
