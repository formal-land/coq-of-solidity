...
Require semanticTests.structs.struct_delete_struct_in_mapping.test.

Definition constructor_code : Code.t :=
  semanticTests.structs.struct_delete_struct_in_mapping.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.structs.struct_delete_struct_in_mapping.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.structs.struct_delete_struct_in_mapping.test.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "62e1c91b";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
