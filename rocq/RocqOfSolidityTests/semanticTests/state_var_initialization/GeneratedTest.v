...
Require semanticTests.state_var_initialization.C.

Definition constructor_code : Code.t :=
  semanticTests.state_var_initialization.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state_var_initialization.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state_var_initialization.C.codes.
