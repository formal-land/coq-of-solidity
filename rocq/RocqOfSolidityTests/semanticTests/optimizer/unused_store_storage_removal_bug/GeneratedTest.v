...
Require semanticTests.optimizer.unused_store_storage_removal_bug.C.

Definition constructor_code : Code.t :=
  semanticTests.optimizer.unused_store_storage_removal_bug.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.optimizer.unused_store_storage_removal_bug.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.optimizer.unused_store_storage_removal_bug.C.codes.
