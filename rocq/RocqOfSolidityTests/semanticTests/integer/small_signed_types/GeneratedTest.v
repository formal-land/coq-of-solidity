...
Require semanticTests.integer.small_signed_types.test.

Definition constructor_code : Code.t :=
  semanticTests.integer.small_signed_types.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.integer.small_signed_types.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.integer.small_signed_types.test.codes.
