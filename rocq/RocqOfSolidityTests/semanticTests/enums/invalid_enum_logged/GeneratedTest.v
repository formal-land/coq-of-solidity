...
Require semanticTests.enums.invalid_enum_logged.C.

Definition constructor_code : Code.t :=
  semanticTests.enums.invalid_enum_logged.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.enums.invalid_enum_logged.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.enums.invalid_enum_logged.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "3c65c00c";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
(* // test_log() -> FAILUREhex"4e487b71", 0x21 *)
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "f8800456";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
