...
Require semanticTests.enums.using_contract_enums_with_explicit_contract_name.test.

Definition constructor_code : Code.t :=
  semanticTests.enums.using_contract_enums_with_explicit_contract_name.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.enums.using_contract_enums_with_explicit_contract_name.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.enums.using_contract_enums_with_explicit_contract_name.test.codes.
