...
Require semanticTests.enums.using_inherited_enum.base.
Require semanticTests.enums.using_inherited_enum.test.

Definition constructor_code : Code.t :=
  semanticTests.enums.using_inherited_enum.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.enums.using_inherited_enum.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.enums.using_inherited_enum.test.codes.
