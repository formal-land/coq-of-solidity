...
Require semanticTests.enums.using_inherited_enum_excplicitly.base.
Require semanticTests.enums.using_inherited_enum_excplicitly.test.

Definition constructor_code : Code.t :=
  semanticTests.enums.using_inherited_enum_excplicitly.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.enums.using_inherited_enum_excplicitly.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.enums.using_inherited_enum_excplicitly.test.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "85bb7d69";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
