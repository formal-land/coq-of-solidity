...
Require semanticTests.expressions.conditional_expression_storage_memory_2.test.

Definition constructor_code : Code.t :=
  semanticTests.expressions.conditional_expression_storage_memory_2.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.conditional_expression_storage_memory_2.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.conditional_expression_storage_memory_2.test.codes.
