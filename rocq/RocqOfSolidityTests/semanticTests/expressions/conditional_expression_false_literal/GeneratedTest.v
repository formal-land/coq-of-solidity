...
Require semanticTests.expressions.conditional_expression_false_literal.test.

Definition constructor_code : Code.t :=
  semanticTests.expressions.conditional_expression_false_literal.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.conditional_expression_false_literal.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.conditional_expression_false_literal.test.codes.
