...
Require semanticTests.expressions.tuple_from_ternary_expression.C.

Definition constructor_code : Code.t :=
  semanticTests.expressions.tuple_from_ternary_expression.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.tuple_from_ternary_expression.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.tuple_from_ternary_expression.C.codes.
