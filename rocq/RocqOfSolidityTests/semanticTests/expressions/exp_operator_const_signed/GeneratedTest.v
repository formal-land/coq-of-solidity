...
Require semanticTests.expressions.exp_operator_const_signed.test.

Definition constructor_code : Code.t :=
  semanticTests.expressions.exp_operator_const_signed.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.exp_operator_const_signed.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.exp_operator_const_signed.test.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff8".
