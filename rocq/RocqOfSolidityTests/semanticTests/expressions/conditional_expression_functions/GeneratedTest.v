...
Require semanticTests.expressions.conditional_expression_functions.test.

Definition constructor_code : Code.t :=
  semanticTests.expressions.conditional_expression_functions.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.conditional_expression_functions.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.conditional_expression_functions.test.codes.
