...
Require semanticTests.expressions.conditional_expression_storage_memory_1.test.

Definition constructor_code : Code.t :=
  semanticTests.expressions.conditional_expression_storage_memory_1.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.conditional_expression_storage_memory_1.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.conditional_expression_storage_memory_1.test.codes.
