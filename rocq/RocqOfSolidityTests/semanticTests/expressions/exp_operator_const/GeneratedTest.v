...
Require semanticTests.expressions.exp_operator_const.test.

Definition constructor_code : Code.t :=
  semanticTests.expressions.exp_operator_const.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.exp_operator_const.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.exp_operator_const.test.codes.
