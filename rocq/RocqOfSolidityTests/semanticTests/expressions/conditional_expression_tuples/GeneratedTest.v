...
Require semanticTests.expressions.conditional_expression_tuples.test.

Definition constructor_code : Code.t :=
  semanticTests.expressions.conditional_expression_tuples.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.conditional_expression_tuples.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.conditional_expression_tuples.test.codes.
