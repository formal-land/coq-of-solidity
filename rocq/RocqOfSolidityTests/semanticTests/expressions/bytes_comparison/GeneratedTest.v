...
Require semanticTests.expressions.bytes_comparison.test.

Definition constructor_code : Code.t :=
  semanticTests.expressions.bytes_comparison.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.bytes_comparison.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.bytes_comparison.test.codes.
