...
Require semanticTests.expressions.unary_too_long_literal.C.

Definition constructor_code : Code.t :=
  semanticTests.expressions.unary_too_long_literal.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.unary_too_long_literal.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.unary_too_long_literal.C.codes.
