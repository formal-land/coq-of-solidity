...
Require semanticTests.expressions.uncalled_address_transfer_send.TransferTest.

Definition constructor_code : Code.t :=
  semanticTests.expressions.uncalled_address_transfer_send.TransferTest.TransferTest.code.

Definition deployed_code : Code.t :=
  semanticTests.expressions.uncalled_address_transfer_send.TransferTest.TransferTest.deployed.code.

Definition codes : list Code.t :=
  semanticTests.expressions.uncalled_address_transfer_send.TransferTest.codes.
