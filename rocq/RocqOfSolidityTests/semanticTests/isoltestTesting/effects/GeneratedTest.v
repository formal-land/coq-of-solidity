...
Require semanticTests.isoltestTesting.effects.SmokeTest.

Definition constructor_code : Code.t :=
  semanticTests.isoltestTesting.effects.SmokeTest.SmokeTest.code.

Definition deployed_code : Code.t :=
  semanticTests.isoltestTesting.effects.SmokeTest.SmokeTest.deployed.code.

Definition codes : list Code.t :=
  semanticTests.isoltestTesting.effects.SmokeTest.codes.
