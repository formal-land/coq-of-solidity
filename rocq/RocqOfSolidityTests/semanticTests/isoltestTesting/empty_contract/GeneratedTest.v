...
Require semanticTests.isoltestTesting.empty_contract.test.

Definition constructor_code : Code.t :=
  semanticTests.isoltestTesting.empty_contract.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.isoltestTesting.empty_contract.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.isoltestTesting.empty_contract.test.codes.
