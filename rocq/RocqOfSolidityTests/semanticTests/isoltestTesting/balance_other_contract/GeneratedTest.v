...
Require semanticTests.isoltestTesting.balance_other_contract.ClientReceipt.
Require semanticTests.isoltestTesting.balance_other_contract.Other.

Definition constructor_code : Code.t :=
  semanticTests.isoltestTesting.balance_other_contract.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  semanticTests.isoltestTesting.balance_other_contract.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list Code.t :=
  semanticTests.isoltestTesting.balance_other_contract.ClientReceipt.codes.

Module Constructor.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 2000;
...
Module Step1.
  Definition environment : Environment.t :={|
    ...
    Environment.calldata := Memory.hex_string_as_bytes "38cc4831";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
