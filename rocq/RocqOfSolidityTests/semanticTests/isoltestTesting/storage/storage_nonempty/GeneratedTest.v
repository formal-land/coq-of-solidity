...
Require semanticTests.isoltestTesting.storage.storage_nonempty.StorageNotEmpty.

Definition constructor_code : Code.t :=
  semanticTests.isoltestTesting.storage.storage_nonempty.StorageNotEmpty.StorageNotEmpty.code.

Definition deployed_code : Code.t :=
  semanticTests.isoltestTesting.storage.storage_nonempty.StorageNotEmpty.StorageNotEmpty.deployed.code.

Definition codes : list Code.t :=
  semanticTests.isoltestTesting.storage.storage_nonempty.StorageNotEmpty.codes.
