...
Require semanticTests.modifiers.modifer_recursive.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.modifer_recursive.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.modifer_recursive.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.modifer_recursive.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "50f9b6cd";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
Module Step2.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "0000000000000000000000000000000000000000000000000000000100000000".
