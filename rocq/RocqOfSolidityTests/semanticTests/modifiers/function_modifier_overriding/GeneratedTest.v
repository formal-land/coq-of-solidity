...
Require semanticTests.modifiers.function_modifier_overriding.A.
Require semanticTests.modifiers.function_modifier_overriding.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.function_modifier_overriding.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.function_modifier_overriding.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.function_modifier_overriding.C.codes.
