...
Require semanticTests.modifiers.function_modifier_local_variables.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.function_modifier_local_variables.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.function_modifier_local_variables.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.function_modifier_local_variables.C.codes.
