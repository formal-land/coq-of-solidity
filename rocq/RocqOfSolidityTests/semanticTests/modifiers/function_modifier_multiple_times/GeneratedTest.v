...
Require semanticTests.modifiers.function_modifier_multiple_times.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.function_modifier_multiple_times.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.function_modifier_multiple_times.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.function_modifier_multiple_times.C.codes.
