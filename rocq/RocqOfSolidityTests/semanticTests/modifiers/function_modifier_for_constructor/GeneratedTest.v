...
Require semanticTests.modifiers.function_modifier_for_constructor.A.
Require semanticTests.modifiers.function_modifier_for_constructor.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.function_modifier_for_constructor.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.function_modifier_for_constructor.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.function_modifier_for_constructor.C.codes.
