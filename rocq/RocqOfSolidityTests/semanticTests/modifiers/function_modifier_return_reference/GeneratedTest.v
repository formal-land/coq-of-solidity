...
Require semanticTests.modifiers.function_modifier_return_reference.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.function_modifier_return_reference.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.function_modifier_return_reference.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.function_modifier_return_reference.C.codes.
