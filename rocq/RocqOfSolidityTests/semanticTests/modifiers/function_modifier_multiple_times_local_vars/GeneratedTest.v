...
Require semanticTests.modifiers.function_modifier_multiple_times_local_vars.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.function_modifier_multiple_times_local_vars.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.function_modifier_multiple_times_local_vars.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.function_modifier_multiple_times_local_vars.C.codes.
