...
Require semanticTests.modifiers.stacked_return_with_modifiers.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.stacked_return_with_modifiers.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.stacked_return_with_modifiers.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.stacked_return_with_modifiers.C.codes.
