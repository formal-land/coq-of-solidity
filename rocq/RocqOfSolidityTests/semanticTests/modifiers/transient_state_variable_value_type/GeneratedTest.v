...
Require semanticTests.modifiers.transient_state_variable_value_type.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.transient_state_variable_value_type.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.transient_state_variable_value_type.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.transient_state_variable_value_type.C.codes.
