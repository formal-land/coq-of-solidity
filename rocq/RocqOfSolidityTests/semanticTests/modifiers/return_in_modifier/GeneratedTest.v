...
Require semanticTests.modifiers.return_in_modifier.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.return_in_modifier.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.return_in_modifier.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.return_in_modifier.C.codes.
