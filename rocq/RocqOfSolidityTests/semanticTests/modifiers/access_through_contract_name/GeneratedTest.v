...
Require semanticTests.modifiers.access_through_contract_name.A.
Require semanticTests.modifiers.access_through_contract_name.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.access_through_contract_name.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.access_through_contract_name.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.access_through_contract_name.C.codes.
