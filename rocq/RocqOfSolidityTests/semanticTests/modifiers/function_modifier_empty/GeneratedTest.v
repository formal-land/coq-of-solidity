...
Require semanticTests.modifiers.function_modifier_empty.A.
Require semanticTests.modifiers.function_modifier_empty.C.

Definition constructor_code : Code.t :=
  semanticTests.modifiers.function_modifier_empty.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.modifiers.function_modifier_empty.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.modifiers.function_modifier_empty.C.codes.
