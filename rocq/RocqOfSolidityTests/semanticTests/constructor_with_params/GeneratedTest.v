...
Require semanticTests.constructor_with_params.C.

Definition constructor_code : Code.t :=
  semanticTests.constructor_with_params.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.constructor_with_params.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constructor_with_params.C.codes.
