...
Require semanticTests.abiEncoderV2.calldata_array_function_types.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_array_function_types.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_array_function_types.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.calldata_array_function_types.C.codes.
