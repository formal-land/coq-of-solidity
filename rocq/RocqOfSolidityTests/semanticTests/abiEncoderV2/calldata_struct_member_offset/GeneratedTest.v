...
Require semanticTests.abiEncoderV2.calldata_struct_member_offset.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_struct_member_offset.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_struct_member_offset.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.calldata_struct_member_offset.C.codes.
