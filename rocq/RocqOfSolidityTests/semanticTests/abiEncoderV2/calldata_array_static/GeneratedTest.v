...
Require semanticTests.abiEncoderV2.calldata_array_static.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_array_static.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_array_static.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.calldata_array_static.C.codes.
