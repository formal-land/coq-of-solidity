...
Require semanticTests.abiEncoderV2.calldata_with_garbage.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_with_garbage.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_with_garbage.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.calldata_with_garbage.C.codes.
