...
Require semanticTests.abiEncoderV2.abi_encode_rational_v2.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.abi_encode_rational_v2.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.abi_encode_rational_v2.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.abi_encode_rational_v2.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
