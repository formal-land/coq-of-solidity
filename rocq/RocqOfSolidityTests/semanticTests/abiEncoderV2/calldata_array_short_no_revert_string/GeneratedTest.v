...
Require semanticTests.abiEncoderV2.calldata_array_short_no_revert_string.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_array_short_no_revert_string.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.calldata_array_short_no_revert_string.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.calldata_array_short_no_revert_string.C.codes.
