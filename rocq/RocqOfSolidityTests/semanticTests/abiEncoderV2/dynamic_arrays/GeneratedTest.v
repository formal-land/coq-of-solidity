...
Require semanticTests.abiEncoderV2.dynamic_arrays.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.dynamic_arrays.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.dynamic_arrays.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.dynamic_arrays.C.codes.
