...
Require semanticTests.abiEncoderV2.struct.mediocre_struct.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.struct.mediocre_struct.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.struct.mediocre_struct.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.struct.mediocre_struct.C.codes.
