...
Require semanticTests.abiEncoderV2.struct.struct_function.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.struct.struct_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.struct.struct_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.struct.struct_function.C.codes.
