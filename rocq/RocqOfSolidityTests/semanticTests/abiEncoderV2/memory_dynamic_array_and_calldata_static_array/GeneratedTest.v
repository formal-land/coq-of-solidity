...
Require semanticTests.abiEncoderV2.memory_dynamic_array_and_calldata_static_array.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.memory_dynamic_array_and_calldata_static_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.memory_dynamic_array_and_calldata_static_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.memory_dynamic_array_and_calldata_static_array.C.codes.
