...
Require semanticTests.abiEncoderV2.enums.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.enums.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.enums.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.enums.C.codes.
