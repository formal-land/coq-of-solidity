...
Require semanticTests.abiEncoderV2.abi_encode_calldata_slice.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.abi_encode_calldata_slice.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.abi_encode_calldata_slice.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.abi_encode_calldata_slice.C.codes.
