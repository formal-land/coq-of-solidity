...
Require semanticTests.abiEncoderV2.cleanup.address.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.cleanup.address.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.cleanup.address.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.cleanup.address.C.codes.
