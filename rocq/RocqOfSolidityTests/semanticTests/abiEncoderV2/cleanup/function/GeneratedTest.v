...
Require semanticTests.abiEncoderV2.cleanup.function.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.cleanup.function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.cleanup.function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.cleanup.function.C.codes.
