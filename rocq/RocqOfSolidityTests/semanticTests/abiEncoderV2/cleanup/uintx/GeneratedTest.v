...
Require semanticTests.abiEncoderV2.cleanup.uintx.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.cleanup.uintx.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.cleanup.uintx.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.cleanup.uintx.C.codes.
