...
Require semanticTests.abiEncoderV2.storage_array_encoding.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.storage_array_encoding.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.storage_array_encoding.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.storage_array_encoding.C.codes.
