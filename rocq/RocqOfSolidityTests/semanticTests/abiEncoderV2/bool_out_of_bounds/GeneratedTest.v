...
Require semanticTests.abiEncoderV2.bool_out_of_bounds.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV2.bool_out_of_bounds.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV2.bool_out_of_bounds.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV2.bool_out_of_bounds.C.codes.
...
Module Step4.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "98c3a6c10000000000000000000000000000000000000000000000000000000000ffffff";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
