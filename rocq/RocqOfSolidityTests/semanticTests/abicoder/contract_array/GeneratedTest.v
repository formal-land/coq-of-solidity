...
Require semanticTests.abicoder.contract_array.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.contract_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.contract_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.contract_array.C.codes.
