...
Require semanticTests.abicoder.abi_encode.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_encode.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_encode.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_encode.C.codes.
