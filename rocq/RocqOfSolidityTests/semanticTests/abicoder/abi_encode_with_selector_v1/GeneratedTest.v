...
Require semanticTests.abicoder.abi_encode_with_selector_v1.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_encode_with_selector_v1.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_encode_with_selector_v1.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_encode_with_selector_v1.C.codes.
