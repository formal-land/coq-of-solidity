...
Require semanticTests.abicoder.cleanup.bool_with_sanity_check_v2.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.cleanup.bool_with_sanity_check_v2.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.cleanup.bool_with_sanity_check_v2.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.cleanup.bool_with_sanity_check_v2.C.codes.
