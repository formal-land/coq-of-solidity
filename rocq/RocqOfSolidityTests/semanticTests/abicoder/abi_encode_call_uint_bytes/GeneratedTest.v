...
Require semanticTests.abicoder.abi_encode_call_uint_bytes.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_encode_call_uint_bytes.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_encode_call_uint_bytes.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_encode_call_uint_bytes.C.codes.
