...
Require semanticTests.abicoder.abi_encode_rational.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_encode_rational.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_encode_rational.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_encode_rational.C.codes.
