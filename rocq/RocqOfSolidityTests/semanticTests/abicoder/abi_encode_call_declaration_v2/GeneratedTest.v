...
Require semanticTests.abicoder.abi_encode_call_declaration_v2.Base.
Require semanticTests.abicoder.abi_encode_call_declaration_v2.C.
Require semanticTests.abicoder.abi_encode_call_declaration_v2.X.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_encode_call_declaration_v2.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_encode_call_declaration_v2.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_encode_call_declaration_v2.C.codes.
