...
Require semanticTests.abicoder.abi_decode_simple_storage.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_decode_simple_storage.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_decode_simple_storage.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_decode_simple_storage.C.codes.
