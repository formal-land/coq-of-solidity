...
Require semanticTests.abicoder.abi_decode_from_calldata.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_decode_from_calldata.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_decode_from_calldata.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_decode_from_calldata.C.codes.
