...
Require semanticTests.abicoder.validation.array_exceeds_calldatasize_no_revert_string.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.validation.array_exceeds_calldatasize_no_revert_string.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.validation.array_exceeds_calldatasize_no_revert_string.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.validation.array_exceeds_calldatasize_no_revert_string.C.codes.
