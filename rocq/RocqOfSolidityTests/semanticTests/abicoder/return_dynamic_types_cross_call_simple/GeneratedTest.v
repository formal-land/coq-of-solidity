...
Require semanticTests.abicoder.return_dynamic_types_cross_call_simple.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.return_dynamic_types_cross_call_simple.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.return_dynamic_types_cross_call_simple.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.return_dynamic_types_cross_call_simple.C.codes.
