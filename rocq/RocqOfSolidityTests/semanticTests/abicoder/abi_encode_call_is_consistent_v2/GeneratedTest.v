...
Require semanticTests.abicoder.abi_encode_call_is_consistent_v2.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_encode_call_is_consistent_v2.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_encode_call_is_consistent_v2.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_encode_call_is_consistent_v2.C.codes.
