...
Require semanticTests.abicoder.abi_encode_calldata_slice.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_encode_calldata_slice.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_encode_calldata_slice.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_encode_calldata_slice.C.codes.
