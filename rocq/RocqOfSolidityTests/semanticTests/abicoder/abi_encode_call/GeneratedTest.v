...
Require semanticTests.abicoder.abi_encode_call.C.

Definition constructor_code : Code.t :=
  semanticTests.abicoder.abi_encode_call.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abicoder.abi_encode_call.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abicoder.abi_encode_call.C.codes.
