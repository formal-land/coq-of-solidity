...
Require semanticTests.getters.struct_with_bytes.C.

Definition constructor_code : Code.t :=
  semanticTests.getters.struct_with_bytes.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.getters.struct_with_bytes.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.getters.struct_with_bytes.C.codes.
