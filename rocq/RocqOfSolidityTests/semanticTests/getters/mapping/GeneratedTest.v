...
Require semanticTests.getters.mapping.C.

Definition constructor_code : Code.t :=
  semanticTests.getters.mapping.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.getters.mapping.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.getters.mapping.C.codes.
