...
Require semanticTests.getters.mapping_with_names.C.

Definition constructor_code : Code.t :=
  semanticTests.getters.mapping_with_names.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.getters.mapping_with_names.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.getters.mapping_with_names.C.codes.
