...
Require semanticTests.getters.transient_value_types.C.

Definition constructor_code : Code.t :=
  semanticTests.getters.transient_value_types.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.getters.transient_value_types.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.getters.transient_value_types.C.codes.
