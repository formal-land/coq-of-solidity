...
Require semanticTests.getters.transient_value_types_multi_frame_call.C.

Definition constructor_code : Code.t :=
  semanticTests.getters.transient_value_types_multi_frame_call.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.getters.transient_value_types_multi_frame_call.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.getters.transient_value_types_multi_frame_call.C.codes.
