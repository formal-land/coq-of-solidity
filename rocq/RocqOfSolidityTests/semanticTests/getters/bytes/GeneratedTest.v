...
Require semanticTests.getters.bytes.C.

Definition constructor_code : Code.t :=
  semanticTests.getters.bytes.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.getters.bytes.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.getters.bytes.C.codes.
