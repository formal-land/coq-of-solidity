...
Require semanticTests.state.block_gaslimit.C.

Definition constructor_code : Code.t :=
  semanticTests.state.block_gaslimit.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.block_gaslimit.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.block_gaslimit.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "0000000000000000000000000000000000000000000000000000000001312d00".
