...
Require semanticTests.state.tx_origin.C.

Definition constructor_code : Code.t :=
  semanticTests.state.tx_origin.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.tx_origin.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.tx_origin.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "0000000000000000000000009292929292929292929292929292929292929292".
