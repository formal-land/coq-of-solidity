...
Require semanticTests.state.block_timestamp.C.

Definition constructor_code : Code.t :=
  semanticTests.state.block_timestamp.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.block_timestamp.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.block_timestamp.C.codes.
