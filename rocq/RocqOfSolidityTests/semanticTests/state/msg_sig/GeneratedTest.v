...
Require semanticTests.state.msg_sig.C.

Definition constructor_code : Code.t :=
  semanticTests.state.msg_sig.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.msg_sig.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.msg_sig.C.codes.
