...
Require semanticTests.state.blobhash.C.

Definition constructor_code : Code.t :=
  semanticTests.state.blobhash.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.blobhash.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.blobhash.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "0100000000000000000000000000000000000000000000000000000000000001".
...
Module Step2.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "0100000000000000000000000000000000000000000000000000000000000002".
