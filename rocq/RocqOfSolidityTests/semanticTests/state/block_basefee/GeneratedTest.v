...
Require semanticTests.state.block_basefee.C.

Definition constructor_code : Code.t :=
  semanticTests.state.block_basefee.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.block_basefee.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.block_basefee.C.codes.
