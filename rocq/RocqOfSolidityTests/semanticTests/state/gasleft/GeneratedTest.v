...
Require semanticTests.state.gasleft.C.

Definition constructor_code : Code.t :=
  semanticTests.state.gasleft.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.gasleft.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.gasleft.C.codes.
