...
Require semanticTests.state.msg_value.C.

Definition constructor_code : Code.t :=
  semanticTests.state.msg_value.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.msg_value.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.msg_value.C.codes.
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 12000000000000000000;
    Environment.calldata := Memory.hex_string_as_bytes "26121ff0";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "000000000000000000000000000000000000000000000000a688906bd8b00000".
