...
Require semanticTests.state.block_prevrandao.C.

Definition constructor_code : Code.t :=
  semanticTests.state.block_prevrandao.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.block_prevrandao.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.block_prevrandao.C.codes.
