...
Require semanticTests.state.block_number.C.

Definition constructor_code : Code.t :=
  semanticTests.state.block_number.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.block_number.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.block_number.C.codes.
