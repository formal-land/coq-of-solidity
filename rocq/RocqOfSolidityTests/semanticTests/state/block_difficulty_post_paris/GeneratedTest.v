...
Require semanticTests.state.block_difficulty_post_paris.C.

Definition constructor_code : Code.t :=
  semanticTests.state.block_difficulty_post_paris.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.block_difficulty_post_paris.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.block_difficulty_post_paris.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "a86c2e601b6c44eb4848f7d23d9df3113fbcac42041c49cbed5000cb4f118777".
