...
Require semanticTests.state.block_chainid.C.

Definition constructor_code : Code.t :=
  semanticTests.state.block_chainid.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.block_chainid.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.block_chainid.C.codes.
