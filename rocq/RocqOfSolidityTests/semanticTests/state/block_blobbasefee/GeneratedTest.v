...
Require semanticTests.state.block_blobbasefee.C.

Definition constructor_code : Code.t :=
  semanticTests.state.block_blobbasefee.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.block_blobbasefee.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.block_blobbasefee.C.codes.
