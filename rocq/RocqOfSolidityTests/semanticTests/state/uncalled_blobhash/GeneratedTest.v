...
Require semanticTests.state.uncalled_blobhash.C.

Definition constructor_code : Code.t :=
  semanticTests.state.uncalled_blobhash.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.uncalled_blobhash.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.uncalled_blobhash.C.codes.
