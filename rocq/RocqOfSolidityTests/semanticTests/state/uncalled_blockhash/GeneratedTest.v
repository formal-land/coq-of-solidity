...
Require semanticTests.state.uncalled_blockhash.C.

Definition constructor_code : Code.t :=
  semanticTests.state.uncalled_blockhash.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.state.uncalled_blockhash.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state.uncalled_blockhash.C.codes.
