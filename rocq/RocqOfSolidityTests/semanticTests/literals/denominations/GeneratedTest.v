...
Require semanticTests.literals.denominations.C.

Definition constructor_code : Code.t :=
  semanticTests.literals.denominations.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.literals.denominations.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.literals.denominations.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "0000000000000000000000000000000000000000000000000de0b6b3e2feca01".
