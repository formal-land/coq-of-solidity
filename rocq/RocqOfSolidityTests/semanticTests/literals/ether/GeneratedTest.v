...
Require semanticTests.literals.ether.C.

Definition constructor_code : Code.t :=
  semanticTests.literals.ether.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.literals.ether.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.literals.ether.C.codes.
