...
Require semanticTests.literals.gwei.C.

Definition constructor_code : Code.t :=
  semanticTests.literals.gwei.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.literals.gwei.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.literals.gwei.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "000000000000000000000000000000000000000000000000000000003b9aca00".
