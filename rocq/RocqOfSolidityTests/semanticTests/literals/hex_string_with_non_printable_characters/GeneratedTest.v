...
Require semanticTests.literals.hex_string_with_non_printable_characters.C.

Definition constructor_code : Code.t :=
  semanticTests.literals.hex_string_with_non_printable_characters.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.literals.hex_string_with_non_printable_characters.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.literals.hex_string_with_non_printable_characters.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f".
