...
Require semanticTests.constructor.order_of_evaluation.A.
Require semanticTests.constructor.order_of_evaluation.B.
Require semanticTests.constructor.order_of_evaluation.C.
Require semanticTests.constructor.order_of_evaluation.D.
Require semanticTests.constructor.order_of_evaluation.X.

Definition constructor_code : Code.t :=
  semanticTests.constructor.order_of_evaluation.X.X.code.

Definition deployed_code : Code.t :=
  semanticTests.constructor.order_of_evaluation.X.X.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constructor.order_of_evaluation.X.codes.
