...
Require semanticTests.constructor.payable_constructor.C.

Definition constructor_code : Code.t :=
  semanticTests.constructor.payable_constructor.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.constructor.payable_constructor.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constructor.payable_constructor.C.codes.
