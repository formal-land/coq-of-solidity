...
Require semanticTests.constructor.no_callvalue_check.A1.
Require semanticTests.constructor.no_callvalue_check.A2.
Require semanticTests.constructor.no_callvalue_check.B1.
Require semanticTests.constructor.no_callvalue_check.B2.
Require semanticTests.constructor.no_callvalue_check.B3.
Require semanticTests.constructor.no_callvalue_check.C.

Definition constructor_code : Code.t :=
  semanticTests.constructor.no_callvalue_check.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.constructor.no_callvalue_check.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constructor.no_callvalue_check.C.codes.
