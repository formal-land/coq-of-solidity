...
Require semanticTests.constructor.store_internal_unused_library_function_in_constructor.C.
Require semanticTests.constructor.store_internal_unused_library_function_in_constructor.L.

Definition constructor_code : Code.t :=
  semanticTests.constructor.store_internal_unused_library_function_in_constructor.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.constructor.store_internal_unused_library_function_in_constructor.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constructor.store_internal_unused_library_function_in_constructor.C.codes.
