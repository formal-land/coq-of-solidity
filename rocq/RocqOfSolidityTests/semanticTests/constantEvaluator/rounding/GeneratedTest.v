...
Require semanticTests.constantEvaluator.rounding.C.

Definition constructor_code : Code.t :=
  semanticTests.constantEvaluator.rounding.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.constantEvaluator.rounding.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.constantEvaluator.rounding.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
