...
Require semanticTests.builtinFunctions.msg_sig.test.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.msg_sig.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.msg_sig.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.msg_sig.test.codes.
