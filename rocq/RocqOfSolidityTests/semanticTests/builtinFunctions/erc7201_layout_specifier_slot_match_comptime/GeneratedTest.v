...
Require semanticTests.builtinFunctions.erc7201_layout_specifier_slot_match_comptime.C.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.erc7201_layout_specifier_slot_match_comptime.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.erc7201_layout_specifier_slot_match_comptime.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.erc7201_layout_specifier_slot_match_comptime.C.codes.
