...
Require semanticTests.builtinFunctions.erc7201_param_with_zero_last_byte_of_inner_hash_comptime.C.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.erc7201_param_with_zero_last_byte_of_inner_hash_comptime.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.erc7201_param_with_zero_last_byte_of_inner_hash_comptime.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.erc7201_param_with_zero_last_byte_of_inner_hash_comptime.C.codes.
