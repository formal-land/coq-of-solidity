...
Require semanticTests.builtinFunctions.blobhash.C.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.blobhash.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.blobhash.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.blobhash.C.codes.
