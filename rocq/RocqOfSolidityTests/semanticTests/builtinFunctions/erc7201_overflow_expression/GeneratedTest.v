...
Require semanticTests.builtinFunctions.erc7201_overflow_expression.C.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.erc7201_overflow_expression.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.erc7201_overflow_expression.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.erc7201_overflow_expression.C.codes.
