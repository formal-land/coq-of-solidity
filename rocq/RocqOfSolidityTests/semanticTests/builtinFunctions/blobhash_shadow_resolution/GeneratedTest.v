...
Require semanticTests.builtinFunctions.blobhash_shadow_resolution.C.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.blobhash_shadow_resolution.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.blobhash_shadow_resolution.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.blobhash_shadow_resolution.C.codes.
