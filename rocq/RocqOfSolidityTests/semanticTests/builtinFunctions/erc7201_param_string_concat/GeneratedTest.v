...
Require semanticTests.builtinFunctions.erc7201_param_string_concat.C.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.erc7201_param_string_concat.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.erc7201_param_string_concat.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.erc7201_param_string_concat.C.codes.
