...
Require semanticTests.builtinFunctions.assignment_to_const_var_involving_keccak.C.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.assignment_to_const_var_involving_keccak.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.assignment_to_const_var_involving_keccak.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.assignment_to_const_var_involving_keccak.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "4e03657aea45a94fc7d47ba826c8d667c0d1e6e33a64a036ec44f58fa12d6c45".
