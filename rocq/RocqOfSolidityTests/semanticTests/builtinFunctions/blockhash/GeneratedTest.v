...
Require semanticTests.builtinFunctions.blockhash.C.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.blockhash.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.blockhash.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.blockhash.C.codes.
