...
Require semanticTests.builtinFunctions.keccak256_packed.C.

Definition constructor_code : Code.t :=
  semanticTests.builtinFunctions.keccak256_packed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.builtinFunctions.keccak256_packed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.builtinFunctions.keccak256_packed.C.codes.
