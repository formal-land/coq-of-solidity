...
Require semanticTests.various.gasleft_decrease.C.

Definition constructor_code : Code.t :=
  semanticTests.various.gasleft_decrease.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.gasleft_decrease.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.gasleft_decrease.C.codes.
