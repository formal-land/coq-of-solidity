...
Require semanticTests.various.code_access_create.C.
Require semanticTests.various.code_access_create.D.

Definition constructor_code : Code.t :=
  semanticTests.various.code_access_create.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.code_access_create.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.code_access_create.C.codes.
