...
Require semanticTests.various.balance.test.

Definition constructor_code : Code.t :=
  semanticTests.various.balance.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.various.balance.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.balance.test.codes.

Module Constructor.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 23;
...
Module Step1.
  Definition environment : Environment.t :={|
    ...
    Environment.calldata := Memory.hex_string_as_bytes "12065fe0";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
