...
Require semanticTests.various.codebalance_assembly.C.

Definition constructor_code : Code.t :=
  semanticTests.various.codebalance_assembly.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.codebalance_assembly.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.codebalance_assembly.C.codes.
