...
Require semanticTests.various.multi_variable_declaration.C.

Definition constructor_code : Code.t :=
  semanticTests.various.multi_variable_declaration.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.multi_variable_declaration.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.multi_variable_declaration.C.codes.
