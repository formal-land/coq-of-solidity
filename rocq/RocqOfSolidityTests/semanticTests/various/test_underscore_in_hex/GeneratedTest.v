...
Require semanticTests.various.test_underscore_in_hex.test.

Definition constructor_code : Code.t :=
  semanticTests.various.test_underscore_in_hex.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.various.test_underscore_in_hex.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.test_underscore_in_hex.test.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "00000000000000000000000000000000000000000000000000000000001234ab".
...
Module Step2.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "00000000000000000000000000000000000000000000000000001234abcd1234".
