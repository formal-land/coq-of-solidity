...
Require semanticTests.various.skip_dynamic_types.C.

Definition constructor_code : Code.t :=
  semanticTests.various.skip_dynamic_types.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.skip_dynamic_types.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.skip_dynamic_types.C.codes.
