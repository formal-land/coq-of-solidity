...
Require semanticTests.various.tuples.C.

Definition constructor_code : Code.t :=
  semanticTests.various.tuples.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.tuples.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.tuples.C.codes.
