...
Require semanticTests.various.decayed_tuple.C.

Definition constructor_code : Code.t :=
  semanticTests.various.decayed_tuple.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.decayed_tuple.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.decayed_tuple.C.codes.
