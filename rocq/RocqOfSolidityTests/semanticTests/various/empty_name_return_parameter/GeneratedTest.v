...
Require semanticTests.various.empty_name_return_parameter.test.

Definition constructor_code : Code.t :=
  semanticTests.various.empty_name_return_parameter.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.various.empty_name_return_parameter.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.empty_name_return_parameter.test.codes.
