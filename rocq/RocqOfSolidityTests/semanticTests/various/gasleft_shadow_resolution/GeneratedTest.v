...
Require semanticTests.various.gasleft_shadow_resolution.C.

Definition constructor_code : Code.t :=
  semanticTests.various.gasleft_shadow_resolution.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.gasleft_shadow_resolution.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.gasleft_shadow_resolution.C.codes.
