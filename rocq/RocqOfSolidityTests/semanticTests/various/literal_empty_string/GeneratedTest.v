...
Require semanticTests.various.literal_empty_string.C.

Definition constructor_code : Code.t :=
  semanticTests.various.literal_empty_string.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.literal_empty_string.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.literal_empty_string.C.codes.
