...
Require semanticTests.various.codehash_assembly.C.

Definition constructor_code : Code.t :=
  semanticTests.various.codehash_assembly.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.codehash_assembly.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.codehash_assembly.C.codes.
