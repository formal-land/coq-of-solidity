...
Require semanticTests.various.crazy_elementary_typenames_on_stack.C.

Definition constructor_code : Code.t :=
  semanticTests.various.crazy_elementary_typenames_on_stack.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.crazy_elementary_typenames_on_stack.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.crazy_elementary_typenames_on_stack.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff9".
