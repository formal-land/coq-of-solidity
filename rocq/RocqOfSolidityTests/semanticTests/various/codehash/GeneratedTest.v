...
Require semanticTests.various.codehash.C.

Definition constructor_code : Code.t :=
  semanticTests.various.codehash.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.codehash.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.codehash.C.codes.
