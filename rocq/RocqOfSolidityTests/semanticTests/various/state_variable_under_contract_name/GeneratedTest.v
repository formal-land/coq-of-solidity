...
Require semanticTests.various.state_variable_under_contract_name.Scope.

Definition constructor_code : Code.t :=
  semanticTests.various.state_variable_under_contract_name.Scope.Scope.code.

Definition deployed_code : Code.t :=
  semanticTests.various.state_variable_under_contract_name.Scope.Scope.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.state_variable_under_contract_name.Scope.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "9ffd5c7f";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
