...
Require semanticTests.various.code_access_padding.C.
Require semanticTests.various.code_access_padding.D.

Definition constructor_code : Code.t :=
  semanticTests.various.code_access_padding.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.code_access_padding.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.code_access_padding.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "a0d7afb7";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
