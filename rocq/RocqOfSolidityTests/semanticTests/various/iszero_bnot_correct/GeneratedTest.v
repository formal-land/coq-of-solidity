...
Require semanticTests.various.iszero_bnot_correct.C.

Definition constructor_code : Code.t :=
  semanticTests.various.iszero_bnot_correct.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.iszero_bnot_correct.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.iszero_bnot_correct.C.codes.
