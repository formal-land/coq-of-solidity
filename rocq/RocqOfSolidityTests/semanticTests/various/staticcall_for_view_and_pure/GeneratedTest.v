...
Require semanticTests.various.staticcall_for_view_and_pure.C.
Require semanticTests.various.staticcall_for_view_and_pure.CPure.
Require semanticTests.various.staticcall_for_view_and_pure.CView.
Require semanticTests.various.staticcall_for_view_and_pure.D.

Definition constructor_code : Code.t :=
  semanticTests.various.staticcall_for_view_and_pure.D.D.code.

Definition deployed_code : Code.t :=
  semanticTests.various.staticcall_for_view_and_pure.D.D.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.staticcall_for_view_and_pure.D.codes.
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "73b0487b";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "e4e0fefc";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
