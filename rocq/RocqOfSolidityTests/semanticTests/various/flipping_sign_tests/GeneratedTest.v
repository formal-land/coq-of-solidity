...
Require semanticTests.various.flipping_sign_tests.test.

Definition constructor_code : Code.t :=
  semanticTests.various.flipping_sign_tests.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.various.flipping_sign_tests.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.flipping_sign_tests.test.codes.
