...
Require semanticTests.various.byte_optimization_bug.C.

Definition constructor_code : Code.t :=
  semanticTests.various.byte_optimization_bug.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.byte_optimization_bug.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.byte_optimization_bug.C.codes.
