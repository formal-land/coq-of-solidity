...
Require semanticTests.various.skip_dynamic_types_for_static_arrays_with_dynamic_elements.C.

Definition constructor_code : Code.t :=
  semanticTests.various.skip_dynamic_types_for_static_arrays_with_dynamic_elements.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.skip_dynamic_types_for_static_arrays_with_dynamic_elements.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.skip_dynamic_types_for_static_arrays_with_dynamic_elements.C.codes.
