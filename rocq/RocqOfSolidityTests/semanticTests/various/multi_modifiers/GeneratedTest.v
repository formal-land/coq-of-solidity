...
Require semanticTests.various.multi_modifiers.C.

Definition constructor_code : Code.t :=
  semanticTests.various.multi_modifiers.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.multi_modifiers.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.multi_modifiers.C.codes.
