...
Require semanticTests.various.value_complex.helper.
Require semanticTests.various.value_complex.test.

Definition constructor_code : Code.t :=
  semanticTests.various.value_complex.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.various.value_complex.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.value_complex.test.codes.
