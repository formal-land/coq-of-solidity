...
Require semanticTests.various.store_bytes.C.

Definition constructor_code : Code.t :=
  semanticTests.various.store_bytes.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.store_bytes.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.store_bytes.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "42dad49e";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "42dad49e6162636465666700000000000000000000000000000000000000000000000000";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
