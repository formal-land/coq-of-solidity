...
Require semanticTests.various.value_insane.helper.
Require semanticTests.various.value_insane.test.

Definition constructor_code : Code.t :=
  semanticTests.various.value_insane.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.various.value_insane.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.value_insane.test.codes.
