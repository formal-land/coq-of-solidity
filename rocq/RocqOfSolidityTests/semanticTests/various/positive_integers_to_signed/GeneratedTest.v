...
Require semanticTests.various.positive_integers_to_signed.test.

Definition constructor_code : Code.t :=
  semanticTests.various.positive_integers_to_signed.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.various.positive_integers_to_signed.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.positive_integers_to_signed.test.codes.
