...
Require semanticTests.various.code_access_runtime.C.
Require semanticTests.various.code_access_runtime.D.

Definition constructor_code : Code.t :=
  semanticTests.various.code_access_runtime.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.various.code_access_runtime.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.code_access_runtime.C.codes.
