...
Require semanticTests.various.selfdestruct_post_cancun_multiple_beneficiaries.C.
Require semanticTests.various.selfdestruct_post_cancun_multiple_beneficiaries.D.

Definition constructor_code : Code.t :=
  semanticTests.various.selfdestruct_post_cancun_multiple_beneficiaries.D.D.code.

Definition deployed_code : Code.t :=
  semanticTests.various.selfdestruct_post_cancun_multiple_beneficiaries.D.D.deployed.code.

Definition codes : list Code.t :=
  semanticTests.various.selfdestruct_post_cancun_multiple_beneficiaries.D.codes.

Module Constructor.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 2000000000000000000;
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "d6be6231";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step4.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "775c300c";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step6.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "edb455290000000000000000000000001111111111111111111111111111111111111111";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
