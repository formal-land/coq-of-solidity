...
Require semanticTests.empty_for_loop.test.

Definition constructor_code : Code.t :=
  semanticTests.empty_for_loop.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.empty_for_loop.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.empty_for_loop.test.codes.
