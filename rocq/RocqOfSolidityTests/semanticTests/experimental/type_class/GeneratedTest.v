...
Require semanticTests.experimental.type_class.C.

Definition constructor_code : Code.t :=
  semanticTests.experimental.type_class.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.experimental.type_class.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.experimental.type_class.C.codes.
