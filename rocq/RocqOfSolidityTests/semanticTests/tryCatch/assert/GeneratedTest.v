...
Require semanticTests.tryCatch.assert.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.assert.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.assert.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.assert.C.codes.
