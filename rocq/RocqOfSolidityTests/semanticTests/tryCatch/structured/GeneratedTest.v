...
Require semanticTests.tryCatch.structured.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.structured.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.structured.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.structured.C.codes.
...
Module Step2.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
