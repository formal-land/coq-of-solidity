...
Require semanticTests.tryCatch.malformed_panic_3.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.malformed_panic_3.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.malformed_panic_3.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.malformed_panic_3.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "4e487b".
...
Module Step2.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "4e487b710000".
