...
Require semanticTests.tryCatch.simple_notuple.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.simple_notuple.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.simple_notuple.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.simple_notuple.C.codes.
