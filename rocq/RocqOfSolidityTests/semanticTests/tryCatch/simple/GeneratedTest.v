...
Require semanticTests.tryCatch.simple.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.simple.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.simple.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.simple.C.codes.
