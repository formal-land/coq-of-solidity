...
Require semanticTests.tryCatch.require.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.require.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.require.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.require.C.codes.
