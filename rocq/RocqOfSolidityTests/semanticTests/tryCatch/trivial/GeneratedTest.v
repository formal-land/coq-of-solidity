...
Require semanticTests.tryCatch.trivial.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.trivial.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.trivial.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.trivial.C.codes.
