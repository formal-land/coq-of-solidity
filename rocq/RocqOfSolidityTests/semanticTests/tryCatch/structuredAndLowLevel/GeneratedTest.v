...
Require semanticTests.tryCatch.structuredAndLowLevel.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.structuredAndLowLevel.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.structuredAndLowLevel.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.structuredAndLowLevel.C.codes.
...
Module Step2.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
