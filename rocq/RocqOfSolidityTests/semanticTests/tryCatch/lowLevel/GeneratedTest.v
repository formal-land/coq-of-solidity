...
Require semanticTests.tryCatch.lowLevel.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.lowLevel.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.lowLevel.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.lowLevel.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
...
Module Step2.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
