...
Require semanticTests.tryCatch.super_trivial.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.super_trivial.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.super_trivial.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.super_trivial.C.codes.
