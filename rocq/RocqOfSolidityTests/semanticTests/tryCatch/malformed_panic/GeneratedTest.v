...
Require semanticTests.tryCatch.malformed_panic.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.malformed_panic.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.malformed_panic.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.malformed_panic.C.codes.
