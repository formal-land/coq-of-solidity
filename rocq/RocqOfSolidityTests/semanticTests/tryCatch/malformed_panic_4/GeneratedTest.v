...
Require semanticTests.tryCatch.malformed_panic_4.C.

Definition constructor_code : Code.t :=
  semanticTests.tryCatch.malformed_panic_4.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.tryCatch.malformed_panic_4.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.tryCatch.malformed_panic_4.C.codes.
