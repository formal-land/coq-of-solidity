...
Require semanticTests.functionSelector.function_selector_via_contract_name.A.
Require semanticTests.functionSelector.function_selector_via_contract_name.B.
Require semanticTests.functionSelector.function_selector_via_contract_name.C.

Definition constructor_code : Code.t :=
  semanticTests.functionSelector.function_selector_via_contract_name.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionSelector.function_selector_via_contract_name.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionSelector.function_selector_via_contract_name.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
