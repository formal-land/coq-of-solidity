...
Require semanticTests.smoke.multiline.C.

Definition constructor_code : Code.t :=
  semanticTests.smoke.multiline.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.smoke.multiline.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.smoke.multiline.C.codes.
