...
Require semanticTests.userDefinedValueType.constant.C.

Definition constructor_code : Code.t :=
  semanticTests.userDefinedValueType.constant.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.userDefinedValueType.constant.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.userDefinedValueType.constant.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "0000000001925c317317e232abd2ce57aa86fc6cd3698c7c097ed0a903275f48".
