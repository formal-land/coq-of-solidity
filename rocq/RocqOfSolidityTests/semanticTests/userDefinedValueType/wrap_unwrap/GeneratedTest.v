...
Require semanticTests.userDefinedValueType.wrap_unwrap.C.

Definition constructor_code : Code.t :=
  semanticTests.userDefinedValueType.wrap_unwrap.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.userDefinedValueType.wrap_unwrap.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.userDefinedValueType.wrap_unwrap.C.codes.
