...
Require semanticTests.userDefinedValueType.abicodec.C.

Definition constructor_code : Code.t :=
  semanticTests.userDefinedValueType.abicodec.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.userDefinedValueType.abicodec.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.userDefinedValueType.abicodec.C.codes.
