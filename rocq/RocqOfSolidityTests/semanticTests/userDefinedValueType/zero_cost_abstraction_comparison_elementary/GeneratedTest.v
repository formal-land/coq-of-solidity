...
Require semanticTests.userDefinedValueType.zero_cost_abstraction_comparison_elementary.C.

Definition constructor_code : Code.t :=
  semanticTests.userDefinedValueType.zero_cost_abstraction_comparison_elementary.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.userDefinedValueType.zero_cost_abstraction_comparison_elementary.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.userDefinedValueType.zero_cost_abstraction_comparison_elementary.C.codes.
