...
Require semanticTests.userDefinedValueType.simple.C.

Definition constructor_code : Code.t :=
  semanticTests.userDefinedValueType.simple.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.userDefinedValueType.simple.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.userDefinedValueType.simple.C.codes.
