...
Require semanticTests.userDefinedValueType.ownable.Ownable.

Definition constructor_code : Code.t :=
  semanticTests.userDefinedValueType.ownable.Ownable.Ownable.code.

Definition deployed_code : Code.t :=
  semanticTests.userDefinedValueType.ownable.Ownable.Ownable.deployed.code.

Definition codes : list Code.t :=
  semanticTests.userDefinedValueType.ownable.Ownable.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "8da5cb5b";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "13af40350000000000000000000000001212121212121212121212121212120000000012";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "715018a6";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
(* // setOwner(address): 0x1212121212121212121212121212120000000012 -> FAILUREhex"5fc483c5" *)
Module Step5.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "5fc483c5".
