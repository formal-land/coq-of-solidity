...
Require semanticTests.userDefinedValueType.calldata.C.

Definition constructor_code : Code.t :=
  semanticTests.userDefinedValueType.calldata.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.userDefinedValueType.calldata.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.userDefinedValueType.calldata.C.codes.
