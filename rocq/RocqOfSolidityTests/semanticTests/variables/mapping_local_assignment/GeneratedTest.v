...
Require semanticTests.variables.mapping_local_assignment.test.

Definition constructor_code : Code.t :=
  semanticTests.variables.mapping_local_assignment.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.variables.mapping_local_assignment.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.variables.mapping_local_assignment.test.codes.
