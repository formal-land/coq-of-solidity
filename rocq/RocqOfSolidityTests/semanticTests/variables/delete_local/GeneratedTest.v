...
Require semanticTests.variables.delete_local.test.

Definition constructor_code : Code.t :=
  semanticTests.variables.delete_local.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.variables.delete_local.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.variables.delete_local.test.codes.
