...
Require semanticTests.variables.public_state_overridding.A.
Require semanticTests.variables.public_state_overridding.X.

Definition constructor_code : Code.t :=
  semanticTests.variables.public_state_overridding.X.X.code.

Definition deployed_code : Code.t :=
  semanticTests.variables.public_state_overridding.X.X.deployed.code.

Definition codes : list Code.t :=
  semanticTests.variables.public_state_overridding.X.codes.
