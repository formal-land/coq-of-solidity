...
Require semanticTests.variables.transient_state_variable_cleanup_assignment.C.

Definition constructor_code : Code.t :=
  semanticTests.variables.transient_state_variable_cleanup_assignment.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.variables.transient_state_variable_cleanup_assignment.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.variables.transient_state_variable_cleanup_assignment.C.codes.
