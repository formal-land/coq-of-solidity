...
Require semanticTests.variables.transient_state_variable_slot_inline_assembly.C.

Definition constructor_code : Code.t :=
  semanticTests.variables.transient_state_variable_slot_inline_assembly.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.variables.transient_state_variable_slot_inline_assembly.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.variables.transient_state_variable_slot_inline_assembly.C.codes.
