...
Require semanticTests.variables.transient_state_variable_slots_and_offsets.C.

Definition constructor_code : Code.t :=
  semanticTests.variables.transient_state_variable_slots_and_offsets.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.variables.transient_state_variable_slots_and_offsets.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.variables.transient_state_variable_slots_and_offsets.C.codes.
