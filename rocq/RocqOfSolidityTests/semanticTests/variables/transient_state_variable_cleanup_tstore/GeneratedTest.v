...
Require semanticTests.variables.transient_state_variable_cleanup_tstore.C.

Definition constructor_code : Code.t :=
  semanticTests.variables.transient_state_variable_cleanup_tstore.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.variables.transient_state_variable_cleanup_tstore.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.variables.transient_state_variable_cleanup_tstore.C.codes.
