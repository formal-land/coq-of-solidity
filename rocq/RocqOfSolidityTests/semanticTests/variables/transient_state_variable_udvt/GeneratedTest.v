...
Require semanticTests.variables.transient_state_variable_udvt.C.

Definition constructor_code : Code.t :=
  semanticTests.variables.transient_state_variable_udvt.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.variables.transient_state_variable_udvt.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.variables.transient_state_variable_udvt.C.codes.
