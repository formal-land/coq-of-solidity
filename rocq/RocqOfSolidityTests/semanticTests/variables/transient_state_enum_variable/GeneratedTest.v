...
Require semanticTests.variables.transient_state_enum_variable.C.

Definition constructor_code : Code.t :=
  semanticTests.variables.transient_state_enum_variable.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.variables.transient_state_enum_variable.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.variables.transient_state_enum_variable.C.codes.
