...
Require semanticTests.inheritance.pass_dynamic_arguments_to_the_base.Base.
Require semanticTests.inheritance.pass_dynamic_arguments_to_the_base.Derived.
Require semanticTests.inheritance.pass_dynamic_arguments_to_the_base.Final.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.pass_dynamic_arguments_to_the_base.Final.Final.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.pass_dynamic_arguments_to_the_base.Final.Final.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.pass_dynamic_arguments_to_the_base.Final.codes.
