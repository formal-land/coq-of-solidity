...
Require semanticTests.inheritance.explicit_base_class.Base.
Require semanticTests.inheritance.explicit_base_class.BaseBase.
Require semanticTests.inheritance.explicit_base_class.Derived.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.explicit_base_class.Derived.Derived.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.explicit_base_class.Derived.Derived.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.explicit_base_class.Derived.codes.
