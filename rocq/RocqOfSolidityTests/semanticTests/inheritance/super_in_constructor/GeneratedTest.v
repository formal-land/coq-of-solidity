...
Require semanticTests.inheritance.super_in_constructor.A.
Require semanticTests.inheritance.super_in_constructor.B.
Require semanticTests.inheritance.super_in_constructor.C.
Require semanticTests.inheritance.super_in_constructor.D.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.super_in_constructor.D.D.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.super_in_constructor.D.D.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.super_in_constructor.D.codes.
