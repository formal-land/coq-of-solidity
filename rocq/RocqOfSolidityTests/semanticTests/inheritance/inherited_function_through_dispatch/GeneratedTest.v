...
Require semanticTests.inheritance.inherited_function_through_dispatch.A.
Require semanticTests.inheritance.inherited_function_through_dispatch.B.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.inherited_function_through_dispatch.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.inherited_function_through_dispatch.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.inherited_function_through_dispatch.B.codes.
