...
Require semanticTests.inheritance.super_overload.A.
Require semanticTests.inheritance.super_overload.B.
Require semanticTests.inheritance.super_overload.C.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.super_overload.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.super_overload.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.super_overload.C.codes.
