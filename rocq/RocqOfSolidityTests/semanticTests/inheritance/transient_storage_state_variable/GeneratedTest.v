...
Require semanticTests.inheritance.transient_storage_state_variable.A.
Require semanticTests.inheritance.transient_storage_state_variable.C.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.transient_storage_state_variable.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.transient_storage_state_variable.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.transient_storage_state_variable.C.codes.
