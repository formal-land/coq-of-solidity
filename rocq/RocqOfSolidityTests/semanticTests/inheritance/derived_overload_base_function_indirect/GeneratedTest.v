...
Require semanticTests.inheritance.derived_overload_base_function_indirect.A.
Require semanticTests.inheritance.derived_overload_base_function_indirect.B.
Require semanticTests.inheritance.derived_overload_base_function_indirect.C.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.derived_overload_base_function_indirect.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.derived_overload_base_function_indirect.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.derived_overload_base_function_indirect.C.codes.
