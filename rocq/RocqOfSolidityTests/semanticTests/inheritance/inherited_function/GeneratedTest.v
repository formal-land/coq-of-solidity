...
Require semanticTests.inheritance.inherited_function.A.
Require semanticTests.inheritance.inherited_function.B.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.inherited_function.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.inherited_function.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.inherited_function.B.codes.
