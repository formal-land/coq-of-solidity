...
Require semanticTests.inheritance.derived_overload_base_function_direct.B.
Require semanticTests.inheritance.derived_overload_base_function_direct.C.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.derived_overload_base_function_direct.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.derived_overload_base_function_direct.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.derived_overload_base_function_direct.C.codes.
