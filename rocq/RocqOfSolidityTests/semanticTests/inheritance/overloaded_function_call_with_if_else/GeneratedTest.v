...
Require semanticTests.inheritance.overloaded_function_call_with_if_else.test.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.overloaded_function_call_with_if_else.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.overloaded_function_call_with_if_else.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.overloaded_function_call_with_if_else.test.codes.
