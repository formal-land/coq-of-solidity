...
Require semanticTests.inheritance.overloaded_function_call_resolve_to_second.test.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.overloaded_function_call_resolve_to_second.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.overloaded_function_call_resolve_to_second.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.overloaded_function_call_resolve_to_second.test.codes.
