...
Require semanticTests.inheritance.base_access_to_function_type_variables.C.

Definition constructor_code : Code.t :=
  semanticTests.inheritance.base_access_to_function_type_variables.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inheritance.base_access_to_function_type_variables.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inheritance.base_access_to_function_type_variables.C.codes.
