...
Require semanticTests.state_variables_init_order_2.A.
Require semanticTests.state_variables_init_order_2.B.

Definition constructor_code : Code.t :=
  semanticTests.state_variables_init_order_2.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.state_variables_init_order_2.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.state_variables_init_order_2.B.codes.
