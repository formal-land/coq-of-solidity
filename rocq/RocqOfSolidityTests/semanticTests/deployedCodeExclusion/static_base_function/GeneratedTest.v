...
Require semanticTests.deployedCodeExclusion.static_base_function.C.
Require semanticTests.deployedCodeExclusion.static_base_function.S.

Definition constructor_code : Code.t :=
  semanticTests.deployedCodeExclusion.static_base_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.deployedCodeExclusion.static_base_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.deployedCodeExclusion.static_base_function.C.codes.
