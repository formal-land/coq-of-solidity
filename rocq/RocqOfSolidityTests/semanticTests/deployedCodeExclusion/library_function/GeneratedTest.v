...
Require semanticTests.deployedCodeExclusion.library_function.C.
Require semanticTests.deployedCodeExclusion.library_function.L.

Definition constructor_code : Code.t :=
  semanticTests.deployedCodeExclusion.library_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.deployedCodeExclusion.library_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.deployedCodeExclusion.library_function.C.codes.
