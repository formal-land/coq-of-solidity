...
Require semanticTests.deployedCodeExclusion.bound_function.C.

Definition constructor_code : Code.t :=
  semanticTests.deployedCodeExclusion.bound_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.deployedCodeExclusion.bound_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.deployedCodeExclusion.bound_function.C.codes.
