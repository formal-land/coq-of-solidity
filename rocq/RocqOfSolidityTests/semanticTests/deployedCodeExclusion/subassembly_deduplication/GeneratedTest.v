...
Require semanticTests.deployedCodeExclusion.subassembly_deduplication.A.
Require semanticTests.deployedCodeExclusion.subassembly_deduplication.C.

Definition constructor_code : Code.t :=
  semanticTests.deployedCodeExclusion.subassembly_deduplication.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.deployedCodeExclusion.subassembly_deduplication.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.deployedCodeExclusion.subassembly_deduplication.C.codes.
