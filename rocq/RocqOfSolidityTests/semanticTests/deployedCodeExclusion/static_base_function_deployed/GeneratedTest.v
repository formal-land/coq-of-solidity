...
Require semanticTests.deployedCodeExclusion.static_base_function_deployed.C.
Require semanticTests.deployedCodeExclusion.static_base_function_deployed.S.

Definition constructor_code : Code.t :=
  semanticTests.deployedCodeExclusion.static_base_function_deployed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.deployedCodeExclusion.static_base_function_deployed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.deployedCodeExclusion.static_base_function_deployed.C.codes.
