...
Require semanticTests.deployedCodeExclusion.super_function.C.
Require semanticTests.deployedCodeExclusion.super_function.S.

Definition constructor_code : Code.t :=
  semanticTests.deployedCodeExclusion.super_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.deployedCodeExclusion.super_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.deployedCodeExclusion.super_function.C.codes.
