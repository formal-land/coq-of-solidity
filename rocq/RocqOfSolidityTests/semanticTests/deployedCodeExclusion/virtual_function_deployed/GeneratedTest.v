...
Require semanticTests.deployedCodeExclusion.virtual_function_deployed.C.
Require semanticTests.deployedCodeExclusion.virtual_function_deployed.S.
Require semanticTests.deployedCodeExclusion.virtual_function_deployed.X.

Definition constructor_code : Code.t :=
  semanticTests.deployedCodeExclusion.virtual_function_deployed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.deployedCodeExclusion.virtual_function_deployed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.deployedCodeExclusion.virtual_function_deployed.C.codes.
