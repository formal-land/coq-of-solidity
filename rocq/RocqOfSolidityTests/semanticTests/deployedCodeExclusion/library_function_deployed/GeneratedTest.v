...
Require semanticTests.deployedCodeExclusion.library_function_deployed.C.
Require semanticTests.deployedCodeExclusion.library_function_deployed.L.

Definition constructor_code : Code.t :=
  semanticTests.deployedCodeExclusion.library_function_deployed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.deployedCodeExclusion.library_function_deployed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.deployedCodeExclusion.library_function_deployed.C.codes.
