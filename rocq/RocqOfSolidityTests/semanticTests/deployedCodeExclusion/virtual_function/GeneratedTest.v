...
Require semanticTests.deployedCodeExclusion.virtual_function.C.
Require semanticTests.deployedCodeExclusion.virtual_function.S.
Require semanticTests.deployedCodeExclusion.virtual_function.X.

Definition constructor_code : Code.t :=
  semanticTests.deployedCodeExclusion.virtual_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.deployedCodeExclusion.virtual_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.deployedCodeExclusion.virtual_function.C.codes.
