...
Require semanticTests.array.concat.bytes_concat_empty_argument_list.C.

Definition constructor_code : Code.t :=
  semanticTests.array.concat.bytes_concat_empty_argument_list.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.concat.bytes_concat_empty_argument_list.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.concat.bytes_concat_empty_argument_list.C.codes.
