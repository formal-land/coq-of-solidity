...
Require semanticTests.array.array_push_with_arg.C.

Definition constructor_code : Code.t :=
  semanticTests.array.array_push_with_arg.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.array_push_with_arg.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.array_push_with_arg.C.codes.
