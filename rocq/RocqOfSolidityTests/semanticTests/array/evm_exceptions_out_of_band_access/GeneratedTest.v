...
Require semanticTests.array.evm_exceptions_out_of_band_access.A.

Definition constructor_code : Code.t :=
  semanticTests.array.evm_exceptions_out_of_band_access.A.A.code.

Definition deployed_code : Code.t :=
  semanticTests.array.evm_exceptions_out_of_band_access.A.A.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.evm_exceptions_out_of_band_access.A.codes.
...
(* // testIt() -> FAILUREhex"4e487b71", 0x32 *)
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
