...
Require semanticTests.array.copying.cleanup_during_multi_element_per_slot_copy.C.

Definition constructor_code : Code.t :=
  semanticTests.array.copying.cleanup_during_multi_element_per_slot_copy.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.copying.cleanup_during_multi_element_per_slot_copy.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.copying.cleanup_during_multi_element_per_slot_copy.C.codes.
