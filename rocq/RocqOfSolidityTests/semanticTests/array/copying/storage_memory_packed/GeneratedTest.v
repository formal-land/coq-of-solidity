...
Require semanticTests.array.copying.storage_memory_packed.C.

Definition constructor_code : Code.t :=
  semanticTests.array.copying.storage_memory_packed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.copying.storage_memory_packed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.copying.storage_memory_packed.C.codes.
