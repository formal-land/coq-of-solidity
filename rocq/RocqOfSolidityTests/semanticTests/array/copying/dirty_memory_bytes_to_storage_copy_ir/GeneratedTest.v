...
Require semanticTests.array.copying.dirty_memory_bytes_to_storage_copy_ir.C.

Definition constructor_code : Code.t :=
  semanticTests.array.copying.dirty_memory_bytes_to_storage_copy_ir.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.copying.dirty_memory_bytes_to_storage_copy_ir.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.copying.dirty_memory_bytes_to_storage_copy_ir.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "6465616462656566000000000000000000000000000000000000000000000010".
