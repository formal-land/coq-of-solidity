...
Require semanticTests.array.copying.copy_byte_array_to_storage.C.

Definition constructor_code : Code.t :=
  semanticTests.array.copying.copy_byte_array_to_storage.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.copying.copy_byte_array_to_storage.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.copying.copy_byte_array_to_storage.C.codes.
