...
Require semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic.C.

Definition constructor_code : Code.t :=
  semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "7d58a8e5";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
