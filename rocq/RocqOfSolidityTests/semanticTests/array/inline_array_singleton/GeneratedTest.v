...
Require semanticTests.array.inline_array_singleton.C.

Definition constructor_code : Code.t :=
  semanticTests.array.inline_array_singleton.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.inline_array_singleton.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.inline_array_singleton.C.codes.
