...
Require semanticTests.array.pop.byte_array_pop_masking_long.c.

Definition constructor_code : Code.t :=
  semanticTests.array.pop.byte_array_pop_masking_long.c.c.code.

Definition deployed_code : Code.t :=
  semanticTests.array.pop.byte_array_pop_masking_long.c.c.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.pop.byte_array_pop_masking_long.c.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
