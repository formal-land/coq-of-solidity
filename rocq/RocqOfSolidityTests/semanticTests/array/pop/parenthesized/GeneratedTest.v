...
Require semanticTests.array.pop.parenthesized.C.

Definition constructor_code : Code.t :=
  semanticTests.array.pop.parenthesized.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.pop.parenthesized.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.pop.parenthesized.C.codes.
