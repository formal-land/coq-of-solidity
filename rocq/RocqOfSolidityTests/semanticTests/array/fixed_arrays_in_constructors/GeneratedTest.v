...
Require semanticTests.array.fixed_arrays_in_constructors.Creator.

Definition constructor_code : Code.t :=
  semanticTests.array.fixed_arrays_in_constructors.Creator.Creator.code.

Definition deployed_code : Code.t :=
  semanticTests.array.fixed_arrays_in_constructors.Creator.Creator.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.fixed_arrays_in_constructors.Creator.codes.
...
Module Constructor.
  ...
  Definition initial_state : State.t :=
    ...
    let account := {|
      ...
      Account.codedata := Memory.hex_string_as_bytes "";
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "d7e96c05";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
