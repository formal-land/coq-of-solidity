...
Require semanticTests.array.dynamic_array_cleanup.c.

Definition constructor_code : Code.t :=
  semanticTests.array.dynamic_array_cleanup.c.c.code.

Definition deployed_code : Code.t :=
  semanticTests.array.dynamic_array_cleanup.c.c.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.dynamic_array_cleanup.c.codes.
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "38b28cb8";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "6bc5fb19";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
