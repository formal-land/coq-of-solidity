...
Require semanticTests.array.create_memory_array.C.

Definition constructor_code : Code.t :=
  semanticTests.array.create_memory_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.create_memory_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.create_memory_array.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
