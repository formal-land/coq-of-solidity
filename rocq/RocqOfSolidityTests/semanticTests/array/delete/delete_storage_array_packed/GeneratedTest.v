...
Require semanticTests.array.delete.delete_storage_array_packed.C.

Definition constructor_code : Code.t :=
  semanticTests.array.delete.delete_storage_array_packed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.delete.delete_storage_array_packed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.delete.delete_storage_array_packed.C.codes.
