...
Require semanticTests.array.delete.delete_on_array_of_structs.C.

Definition constructor_code : Code.t :=
  semanticTests.array.delete.delete_on_array_of_structs.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.delete.delete_on_array_of_structs.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.delete.delete_on_array_of_structs.C.codes.
