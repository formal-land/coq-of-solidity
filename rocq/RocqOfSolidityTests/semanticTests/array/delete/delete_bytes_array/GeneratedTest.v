...
Require semanticTests.array.delete.delete_bytes_array.C.

Definition constructor_code : Code.t :=
  semanticTests.array.delete.delete_bytes_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.delete.delete_bytes_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.delete.delete_bytes_array.C.codes.
