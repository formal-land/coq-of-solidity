...
Module C.
  Definition code : Code.t := {|
    Code.name := "C_72";
    Code.hex_name := 0x435f373200000000000000000000000000000000000000000000000000000000;
    Code.functions :=
      [
            ...
            do! ltac:(M.monadic (
              M.declare (|
                ...
                Some (M.call_function (|
                  "datasize",
                  [
                    [Literal.string 0x435f37325f6465706c6f79656400000000000000000000000000000000000000]
                  ]
                |))
              |)
            )) in
  ...
  Module deployed.
    Definition code : Code.t := {|
      Code.name := "C_72_deployed";
      Code.hex_name := 0x435f37325f6465706c6f79656400000000000000000000000000000000000000;
      Code.functions :=
        [
          Code.Function.make (
            "panic_error_0x41",
          ...
          Code.Function.make (
            "array_push_from_t_bytes1_to_t_bytes_storage_ptr",
            [],
            [],
            M.scope (
              do! ltac:(M.monadic (
