...
Require semanticTests.array.delete.delete_memory_array.C.

Definition constructor_code : Code.t :=
  semanticTests.array.delete.delete_memory_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.array.delete.delete_memory_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.array.delete.delete_memory_array.C.codes.
