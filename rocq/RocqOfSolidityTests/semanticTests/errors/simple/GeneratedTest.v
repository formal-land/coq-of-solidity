...
Require semanticTests.errors.simple.C.

Definition constructor_code : Code.t :=
  semanticTests.errors.simple.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.errors.simple.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.errors.simple.C.codes.
