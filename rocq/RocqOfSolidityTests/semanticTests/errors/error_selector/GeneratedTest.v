...
Require semanticTests.errors.error_selector.C.
Require semanticTests.errors.error_selector.D.
Require semanticTests.errors.error_selector.I.
Require semanticTests.errors.error_selector.L.
Require semanticTests.errors.error_selector.S.
Require semanticTests.errors.error_selector.T.

Definition constructor_code : Code.t :=
  semanticTests.errors.error_selector.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.errors.error_selector.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.errors.error_selector.C.codes.
