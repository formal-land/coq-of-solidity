...
Require semanticTests.errors.require_error_evaluation_order_1.C.

Definition constructor_code : Code.t :=
  semanticTests.errors.require_error_evaluation_order_1.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.errors.require_error_evaluation_order_1.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.errors.require_error_evaluation_order_1.C.codes.
