...
Require semanticTests.errors.error_static_calldata_uint_array_and_dynamic_array.C.

Definition constructor_code : Code.t :=
  semanticTests.errors.error_static_calldata_uint_array_and_dynamic_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.errors.error_static_calldata_uint_array_and_dynamic_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.errors.error_static_calldata_uint_array_and_dynamic_array.C.codes.
...
(* // f(uint256[],uint256[1]): 0x40, 0xff, 1, 0xffff -> FAILUREhex"f42f106d", 0x40, 0xff, 1, 0xffff *)
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
