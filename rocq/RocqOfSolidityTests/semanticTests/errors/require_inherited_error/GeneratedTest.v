...
Require semanticTests.errors.require_inherited_error.Base.
Require semanticTests.errors.require_inherited_error.C.

Definition constructor_code : Code.t :=
  semanticTests.errors.require_inherited_error.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.errors.require_inherited_error.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.errors.require_inherited_error.C.codes.
