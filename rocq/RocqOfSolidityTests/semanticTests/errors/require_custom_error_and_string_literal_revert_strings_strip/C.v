                ...
                M.expr_stmt (|
                  M.call_function (|
                    ...
                    [
                      ...
                      |);
                      [Literal.string 0x4572726f72000000000000000000000000000000000000000000000000000000]
                    ]
                  |)
                |)
              )) in
                  ...
                  M.scope (
                    do! ltac:(M.monadic (
                      M.switch (|
                        ...
                        [
                          (
                            Some (Literal.number 0xb5d549e9),
                            M.scope (
                              do! ltac:(M.monadic (
                                M.if_ (|
                                  M.call_function (|
                          ...
                          (
                            Some (Literal.number 0xdda3a7bd),
                            M.scope (
                              do! ltac:(M.monadic (
                                M.if_ (|
                                  M.call_function (|
