...
Require semanticTests.errors.require_error_function_pointer_parameter.C.

Definition constructor_code : Code.t :=
  semanticTests.errors.require_error_function_pointer_parameter.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.errors.require_error_function_pointer_parameter.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.errors.require_error_function_pointer_parameter.C.codes.
...
(* // f() -> FAILUREhex"271b1dfa", hex"0000000000000000000000000000000000001234f37cdc8e0000000000000000" *)
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "271b1dfa0000000000000000000000000000000000001234f37cdc8e0000000000000000".
