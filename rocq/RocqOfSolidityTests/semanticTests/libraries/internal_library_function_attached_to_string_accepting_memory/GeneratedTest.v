...
Require semanticTests.libraries.internal_library_function_attached_to_string_accepting_memory.C.
Require semanticTests.libraries.internal_library_function_attached_to_string_accepting_memory.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_string_accepting_memory.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_string_accepting_memory.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_string_accepting_memory.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "d39d44b3";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
