...
Require semanticTests.libraries.internal_library_function_attached_to_array_named_pop_push.C.
Require semanticTests.libraries.internal_library_function_attached_to_array_named_pop_push.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_array_named_pop_push.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_array_named_pop_push.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_array_named_pop_push.C.codes.
