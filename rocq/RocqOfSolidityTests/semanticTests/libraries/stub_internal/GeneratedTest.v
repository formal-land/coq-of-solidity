...
Require semanticTests.libraries.stub_internal.C.
Require semanticTests.libraries.stub_internal.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.stub_internal.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.stub_internal.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.stub_internal.C.codes.
