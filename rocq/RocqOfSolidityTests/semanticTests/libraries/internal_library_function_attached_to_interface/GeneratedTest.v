...
Require semanticTests.libraries.internal_library_function_attached_to_interface.C.
Require semanticTests.libraries.internal_library_function_attached_to_interface.E.
Require semanticTests.libraries.internal_library_function_attached_to_interface.I.
Require semanticTests.libraries.internal_library_function_attached_to_interface.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_interface.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_interface.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_interface.C.codes.
