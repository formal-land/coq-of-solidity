...
Require semanticTests.libraries.internal_library_function_attached_to_contract.C.
Require semanticTests.libraries.internal_library_function_attached_to_contract.E.
Require semanticTests.libraries.internal_library_function_attached_to_contract.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_contract.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_contract.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_contract.C.codes.
