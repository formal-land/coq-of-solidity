...
Require semanticTests.libraries.internal_library_function_calling_private.C.
Require semanticTests.libraries.internal_library_function_calling_private.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.internal_library_function_calling_private.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.internal_library_function_calling_private.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.internal_library_function_calling_private.C.codes.
