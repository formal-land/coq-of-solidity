...
Require semanticTests.libraries.internal_call_unattached_with_parentheses.C.
Require semanticTests.libraries.internal_call_unattached_with_parentheses.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.internal_call_unattached_with_parentheses.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.internal_call_unattached_with_parentheses.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.internal_call_unattached_with_parentheses.C.codes.
