...
Require semanticTests.libraries.internal_library_function_attached_to_struct.C.
Require semanticTests.libraries.internal_library_function_attached_to_struct.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_struct.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_struct.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.internal_library_function_attached_to_struct.C.codes.
