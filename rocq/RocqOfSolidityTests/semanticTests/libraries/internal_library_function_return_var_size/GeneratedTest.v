...
Require semanticTests.libraries.internal_library_function_return_var_size.C.
Require semanticTests.libraries.internal_library_function_return_var_size.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.internal_library_function_return_var_size.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.internal_library_function_return_var_size.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.internal_library_function_return_var_size.C.codes.
