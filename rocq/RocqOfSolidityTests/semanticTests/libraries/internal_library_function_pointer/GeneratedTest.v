...
Require semanticTests.libraries.internal_library_function_pointer.C.
Require semanticTests.libraries.internal_library_function_pointer.L.

Definition constructor_code : Code.t :=
  semanticTests.libraries.internal_library_function_pointer.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.libraries.internal_library_function_pointer.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.libraries.internal_library_function_pointer.C.codes.
