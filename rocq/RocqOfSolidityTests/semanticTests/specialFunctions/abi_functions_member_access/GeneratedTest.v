...
Require semanticTests.specialFunctions.abi_functions_member_access.C.

Definition constructor_code : Code.t :=
  semanticTests.specialFunctions.abi_functions_member_access.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.specialFunctions.abi_functions_member_access.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.specialFunctions.abi_functions_member_access.C.codes.
