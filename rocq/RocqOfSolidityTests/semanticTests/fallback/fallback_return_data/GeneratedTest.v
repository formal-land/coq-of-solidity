...
Require semanticTests.fallback.fallback_return_data.A.

Definition constructor_code : Code.t :=
  semanticTests.fallback.fallback_return_data.A.A.code.

Definition deployed_code : Code.t :=
  semanticTests.fallback.fallback_return_data.A.A.deployed.code.

Definition codes : list Code.t :=
  semanticTests.fallback.fallback_return_data.A.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
