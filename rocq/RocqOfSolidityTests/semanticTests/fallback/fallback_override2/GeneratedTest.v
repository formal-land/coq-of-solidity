...
Require semanticTests.fallback.fallback_override2.A.
Require semanticTests.fallback.fallback_override2.B.

Definition constructor_code : Code.t :=
  semanticTests.fallback.fallback_override2.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.fallback.fallback_override2.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.fallback.fallback_override2.B.codes.
