...
Require semanticTests.fallback.call_forward_bytes.receiver.
Require semanticTests.fallback.call_forward_bytes.sender.

Definition constructor_code : Code.t :=
  semanticTests.fallback.call_forward_bytes.sender.sender.code.

Definition deployed_code : Code.t :=
  semanticTests.fallback.call_forward_bytes.sender.sender.deployed.code.

Definition codes : list Code.t :=
  semanticTests.fallback.call_forward_bytes.sender.codes.
