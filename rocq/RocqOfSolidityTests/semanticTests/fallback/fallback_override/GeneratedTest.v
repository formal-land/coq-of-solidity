...
Require semanticTests.fallback.fallback_override.A.
Require semanticTests.fallback.fallback_override.B.

Definition constructor_code : Code.t :=
  semanticTests.fallback.fallback_override.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.fallback.fallback_override.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.fallback.fallback_override.B.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
