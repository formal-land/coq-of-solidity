...
Require semanticTests.reverts.invalid_enum_compared.C.

Definition constructor_code : Code.t :=
  semanticTests.reverts.invalid_enum_compared.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.reverts.invalid_enum_compared.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.reverts.invalid_enum_compared.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "ffbb17b5";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
(* // test_eq() -> FAILUREhex"4e487b71", 33 # both should throw # *)
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "6063214e";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
(* // test_neq() -> FAILUREhex"4e487b71", 33 *)
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "7f5dfda4";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
