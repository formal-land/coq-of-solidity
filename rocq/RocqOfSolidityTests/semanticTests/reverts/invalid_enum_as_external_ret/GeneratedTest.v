...
Require semanticTests.reverts.invalid_enum_as_external_ret.C.

Definition constructor_code : Code.t :=
  semanticTests.reverts.invalid_enum_as_external_ret.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.reverts.invalid_enum_as_external_ret.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.reverts.invalid_enum_as_external_ret.C.codes.
...
(* // test_return() -> FAILUREhex"4e487b71", 33 # both should throw # *)
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "df9f5ccb";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
(* // test_inline_assignment() -> FAILUREhex"4e487b71", 33 *)
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "db06ccd1";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
(* // test_assignment() -> FAILUREhex"4e487b71", 33 *)
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "f73d79ee";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
