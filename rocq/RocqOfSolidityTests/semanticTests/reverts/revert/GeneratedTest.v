...
Require semanticTests.reverts.revert.C.

Definition constructor_code : Code.t :=
  semanticTests.reverts.revert.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.reverts.revert.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.reverts.revert.C.codes.
