...
Require semanticTests.reverts.invalid_enum_stored.C.

Definition constructor_code : Code.t :=
  semanticTests.reverts.invalid_enum_stored.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.reverts.invalid_enum_stored.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.reverts.invalid_enum_stored.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "d7b52a1f";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
(* // test_store() -> FAILUREhex"4e487b71", 33 # should throw # *)
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "ef9d1d86";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
