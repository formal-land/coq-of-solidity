...
Require semanticTests.reverts.invalid_enum_as_external_arg.C.

Definition constructor_code : Code.t :=
  semanticTests.reverts.invalid_enum_as_external_arg.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.reverts.invalid_enum_as_external_arg.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.reverts.invalid_enum_as_external_arg.C.codes.
...
(* // test() -> FAILUREhex"4e487b71", 0x21 # should throw # *)
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
