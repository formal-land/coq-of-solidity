...
Require semanticTests.reverts.invalid_instruction.C.

Definition constructor_code : Code.t :=
  semanticTests.reverts.invalid_instruction.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.reverts.invalid_instruction.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.reverts.invalid_instruction.C.codes.
