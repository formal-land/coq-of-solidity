...
Require semanticTests.cleanup.cleanup_bytes_types_shortening_newCodeGen.C.

Definition constructor_code : Code.t :=
  semanticTests.cleanup.cleanup_bytes_types_shortening_newCodeGen.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.cleanup.cleanup_bytes_types_shortening_newCodeGen.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.cleanup.cleanup_bytes_types_shortening_newCodeGen.C.codes.
