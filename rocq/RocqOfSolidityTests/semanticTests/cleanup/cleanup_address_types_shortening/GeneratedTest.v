...
Require semanticTests.cleanup.cleanup_address_types_shortening.C.

Definition constructor_code : Code.t :=
  semanticTests.cleanup.cleanup_address_types_shortening.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.cleanup.cleanup_address_types_shortening.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.cleanup.cleanup_address_types_shortening.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "0000000000000000000000001122334455667788990011223344556677889900".
