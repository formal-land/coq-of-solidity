...
Require semanticTests.cleanup.exp_cleanup_direct.C.

Definition constructor_code : Code.t :=
  semanticTests.cleanup.exp_cleanup_direct.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.cleanup.exp_cleanup_direct.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.cleanup.exp_cleanup_direct.C.codes.
