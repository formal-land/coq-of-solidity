...
Require semanticTests.cleanup.exp_cleanup_nonzero_base.C.

Definition constructor_code : Code.t :=
  semanticTests.cleanup.exp_cleanup_nonzero_base.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.cleanup.exp_cleanup_nonzero_base.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.cleanup.exp_cleanup_nonzero_base.C.codes.
