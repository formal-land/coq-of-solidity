...
Require semanticTests.cleanup.exp_cleanup_smaller_base.C.

Definition constructor_code : Code.t :=
  semanticTests.cleanup.exp_cleanup_smaller_base.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.cleanup.exp_cleanup_smaller_base.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.cleanup.exp_cleanup_smaller_base.C.codes.
