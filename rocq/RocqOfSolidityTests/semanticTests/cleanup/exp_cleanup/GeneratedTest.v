...
Require semanticTests.cleanup.exp_cleanup.C.

Definition constructor_code : Code.t :=
  semanticTests.cleanup.exp_cleanup.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.cleanup.exp_cleanup.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.cleanup.exp_cleanup.C.codes.
