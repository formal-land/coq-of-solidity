...
Require semanticTests.cleanup.indexed_log_topic_during_explicit_downcast_during_emissions.C.

Definition constructor_code : Code.t :=
  semanticTests.cleanup.indexed_log_topic_during_explicit_downcast_during_emissions.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.cleanup.indexed_log_topic_during_explicit_downcast_during_emissions.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.cleanup.indexed_log_topic_during_explicit_downcast_during_emissions.C.codes.
