...
Require semanticTests.types.nested_tuples.test.

Definition constructor_code : Code.t :=
  semanticTests.types.nested_tuples.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.types.nested_tuples.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.types.nested_tuples.test.codes.
