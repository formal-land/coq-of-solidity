...
Require semanticTests.types.mapping_enum_key_v2.test.

Definition constructor_code : Code.t :=
  semanticTests.types.mapping_enum_key_v2.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.types.mapping_enum_key_v2.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.types.mapping_enum_key_v2.test.codes.
