...
Require semanticTests.types.convert_fixed_bytes_to_uint_same_type.Test.

Definition constructor_code : Code.t :=
  semanticTests.types.convert_fixed_bytes_to_uint_same_type.Test.Test.code.

Definition deployed_code : Code.t :=
  semanticTests.types.convert_fixed_bytes_to_uint_same_type.Test.Test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.types.convert_fixed_bytes_to_uint_same_type.Test.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "cfc5a9696162633200000000000000000000000000000000000000000000000000000000";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "6162633200000000000000000000000000000000000000000000000000000000".
