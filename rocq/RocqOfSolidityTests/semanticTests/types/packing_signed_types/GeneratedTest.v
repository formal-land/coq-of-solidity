...
Require semanticTests.types.packing_signed_types.test.

Definition constructor_code : Code.t :=
  semanticTests.types.packing_signed_types.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.types.packing_signed_types.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.types.packing_signed_types.test.codes.
