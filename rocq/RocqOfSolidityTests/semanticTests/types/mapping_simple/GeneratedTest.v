...
Require semanticTests.types.mapping_simple.test.

Definition constructor_code : Code.t :=
  semanticTests.types.mapping_simple.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.types.mapping_simple.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.types.mapping_simple.test.codes.
