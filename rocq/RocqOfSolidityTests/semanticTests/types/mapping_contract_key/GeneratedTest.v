...
Require semanticTests.types.mapping_contract_key.A.
Require semanticTests.types.mapping_contract_key.test.

Definition constructor_code : Code.t :=
  semanticTests.types.mapping_contract_key.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.types.mapping_contract_key.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.types.mapping_contract_key.test.codes.
