...
Require semanticTests.types.external_function_to_address.C.

Definition constructor_code : Code.t :=
  semanticTests.types.external_function_to_address.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.types.external_function_to_address.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.types.external_function_to_address.C.codes.
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "a0b2b43b000000000000000000000000000000000000004226121ff00000000000000000";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
