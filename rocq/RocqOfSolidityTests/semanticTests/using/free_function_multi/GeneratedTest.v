...
Require semanticTests.using.free_function_multi.C.

Definition constructor_code : Code.t :=
  semanticTests.using.free_function_multi.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.using.free_function_multi.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.using.free_function_multi.C.codes.
