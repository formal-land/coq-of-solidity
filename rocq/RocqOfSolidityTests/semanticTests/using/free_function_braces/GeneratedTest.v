...
Require semanticTests.using.free_function_braces.C.

Definition constructor_code : Code.t :=
  semanticTests.using.free_function_braces.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.using.free_function_braces.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.using.free_function_braces.C.codes.
