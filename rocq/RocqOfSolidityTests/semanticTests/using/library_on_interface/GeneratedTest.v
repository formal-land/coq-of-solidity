...
Require semanticTests.using.library_on_interface.C.
Require semanticTests.using.library_on_interface.I.
Require semanticTests.using.library_on_interface.L.

Definition constructor_code : Code.t :=
  semanticTests.using.library_on_interface.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.using.library_on_interface.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.using.library_on_interface.C.codes.
