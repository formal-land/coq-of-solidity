...
Require semanticTests.dirty_calldata_bytes.C.

Definition constructor_code : Code.t :=
  semanticTests.dirty_calldata_bytes.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.dirty_calldata_bytes.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.dirty_calldata_bytes.C.codes.
