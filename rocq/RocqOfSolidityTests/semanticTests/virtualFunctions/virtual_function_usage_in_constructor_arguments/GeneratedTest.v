...
Require semanticTests.virtualFunctions.virtual_function_usage_in_constructor_arguments.Base.
Require semanticTests.virtualFunctions.virtual_function_usage_in_constructor_arguments.BaseBase.
Require semanticTests.virtualFunctions.virtual_function_usage_in_constructor_arguments.Derived.

Definition constructor_code : Code.t :=
  semanticTests.virtualFunctions.virtual_function_usage_in_constructor_arguments.Derived.Derived.code.

Definition deployed_code : Code.t :=
  semanticTests.virtualFunctions.virtual_function_usage_in_constructor_arguments.Derived.Derived.deployed.code.

Definition codes : list Code.t :=
  semanticTests.virtualFunctions.virtual_function_usage_in_constructor_arguments.Derived.codes.
