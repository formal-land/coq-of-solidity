...
Require semanticTests.virtualFunctions.virtual_override_changing_mutability_internal.A.
Require semanticTests.virtualFunctions.virtual_override_changing_mutability_internal.C.

Definition constructor_code : Code.t :=
  semanticTests.virtualFunctions.virtual_override_changing_mutability_internal.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.virtualFunctions.virtual_override_changing_mutability_internal.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.virtualFunctions.virtual_override_changing_mutability_internal.C.codes.
