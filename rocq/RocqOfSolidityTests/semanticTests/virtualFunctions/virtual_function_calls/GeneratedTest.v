...
Require semanticTests.virtualFunctions.virtual_function_calls.Base.
Require semanticTests.virtualFunctions.virtual_function_calls.Derived.

Definition constructor_code : Code.t :=
  semanticTests.virtualFunctions.virtual_function_calls.Derived.Derived.code.

Definition deployed_code : Code.t :=
  semanticTests.virtualFunctions.virtual_function_calls.Derived.Derived.deployed.code.

Definition codes : list Code.t :=
  semanticTests.virtualFunctions.virtual_function_calls.Derived.codes.
