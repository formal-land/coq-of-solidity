...
Require semanticTests.virtualFunctions.virtual_override_changing_mutability_public.A.
Require semanticTests.virtualFunctions.virtual_override_changing_mutability_public.C.

Definition constructor_code : Code.t :=
  semanticTests.virtualFunctions.virtual_override_changing_mutability_public.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.virtualFunctions.virtual_override_changing_mutability_public.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.virtualFunctions.virtual_override_changing_mutability_public.C.codes.
