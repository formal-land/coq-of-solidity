...
Require semanticTests.virtualFunctions.internal_virtual_function_calls_through_dispatch.Base.
Require semanticTests.virtualFunctions.internal_virtual_function_calls_through_dispatch.Derived.

Definition constructor_code : Code.t :=
  semanticTests.virtualFunctions.internal_virtual_function_calls_through_dispatch.Derived.Derived.code.

Definition deployed_code : Code.t :=
  semanticTests.virtualFunctions.internal_virtual_function_calls_through_dispatch.Derived.Derived.deployed.code.

Definition codes : list Code.t :=
  semanticTests.virtualFunctions.internal_virtual_function_calls_through_dispatch.Derived.codes.
