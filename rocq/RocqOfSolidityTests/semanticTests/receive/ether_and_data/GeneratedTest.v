...
Require semanticTests.receive.ether_and_data.C.

Definition constructor_code : Code.t :=
  semanticTests.receive.ether_and_data.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.receive.ether_and_data.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.receive.ether_and_data.C.codes.
