...
Require semanticTests.receive.inherited.A.
Require semanticTests.receive.inherited.B.

Definition constructor_code : Code.t :=
  semanticTests.receive.inherited.B.B.code.

Definition deployed_code : Code.t :=
  semanticTests.receive.inherited.B.B.deployed.code.

Definition codes : list Code.t :=
  semanticTests.receive.inherited.B.codes.
