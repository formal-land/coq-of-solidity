...
Require semanticTests.ecrecover.failing_ecrecover_invalid_input_proper.C.

Definition constructor_code : Code.t :=
  semanticTests.ecrecover.failing_ecrecover_invalid_input_proper.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.ecrecover.failing_ecrecover_invalid_input_proper.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.ecrecover.failing_ecrecover_invalid_input_proper.C.codes.
