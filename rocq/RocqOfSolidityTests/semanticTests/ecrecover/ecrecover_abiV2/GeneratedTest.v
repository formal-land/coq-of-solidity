...
Require semanticTests.ecrecover.ecrecover_abiV2.test.

Definition constructor_code : Code.t :=
  semanticTests.ecrecover.ecrecover_abiV2.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.ecrecover.ecrecover_abiV2.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.ecrecover.ecrecover_abiV2.test.codes.
