...
Require semanticTests.ecrecover.failing_ecrecover_invalid_input.C.

Definition constructor_code : Code.t :=
  semanticTests.ecrecover.failing_ecrecover_invalid_input.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.ecrecover.failing_ecrecover_invalid_input.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.ecrecover.failing_ecrecover_invalid_input.C.codes.
