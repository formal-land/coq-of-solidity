...
Require semanticTests.ecrecover.failing_ecrecover_invalid_input_asm.C.

Definition constructor_code : Code.t :=
  semanticTests.ecrecover.failing_ecrecover_invalid_input_asm.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.ecrecover.failing_ecrecover_invalid_input_asm.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.ecrecover.failing_ecrecover_invalid_input_asm.C.codes.
