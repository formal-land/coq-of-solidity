...
Require semanticTests.abiencodedecode.abi_encode_with_signaturev2.C.

Definition constructor_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_with_signaturev2.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_with_signaturev2.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiencodedecode.abi_encode_with_signaturev2.C.codes.
