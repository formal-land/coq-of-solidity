...
Require semanticTests.abiencodedecode.abi_encode_call_is_consistent.C.

Definition constructor_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_is_consistent.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_is_consistent.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_is_consistent.C.codes.
