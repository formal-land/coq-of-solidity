...
Require semanticTests.abiencodedecode.abi_encode_call_declaration.Base.
Require semanticTests.abiencodedecode.abi_encode_call_declaration.C.
Require semanticTests.abiencodedecode.abi_encode_call_declaration.X.

Definition constructor_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_declaration.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_declaration.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_declaration.C.codes.
