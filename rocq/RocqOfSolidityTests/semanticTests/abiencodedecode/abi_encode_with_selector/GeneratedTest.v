...
Require semanticTests.abiencodedecode.abi_encode_with_selector.C.

Definition constructor_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_with_selector.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_with_selector.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiencodedecode.abi_encode_with_selector.C.codes.
