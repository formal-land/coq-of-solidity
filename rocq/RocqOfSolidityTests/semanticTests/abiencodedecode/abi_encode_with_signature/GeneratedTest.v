...
Require semanticTests.abiencodedecode.abi_encode_with_signature.C.

Definition constructor_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_with_signature.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_with_signature.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiencodedecode.abi_encode_with_signature.C.codes.
