...
Require semanticTests.abiencodedecode.abi_decode_calldata.C.

Definition constructor_code : Code.t :=
  semanticTests.abiencodedecode.abi_decode_calldata.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiencodedecode.abi_decode_calldata.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiencodedecode.abi_decode_calldata.C.codes.
