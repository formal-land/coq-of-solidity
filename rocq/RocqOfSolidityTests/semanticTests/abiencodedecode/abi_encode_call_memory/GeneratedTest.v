...
Require semanticTests.abiencodedecode.abi_encode_call_memory.C.
Require semanticTests.abiencodedecode.abi_encode_call_memory.D.

Definition constructor_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_memory.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_memory.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_memory.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "a7a0d53700000000000000000000000000000000000000000000000000000000".
