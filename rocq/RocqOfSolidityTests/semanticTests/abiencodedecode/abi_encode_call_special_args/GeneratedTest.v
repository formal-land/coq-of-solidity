...
Require semanticTests.abiencodedecode.abi_encode_call_special_args.C.

Definition constructor_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_special_args.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_special_args.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiencodedecode.abi_encode_call_special_args.C.codes.
