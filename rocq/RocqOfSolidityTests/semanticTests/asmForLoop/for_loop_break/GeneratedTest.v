...
Require semanticTests.asmForLoop.for_loop_break.C.

Definition constructor_code : Code.t :=
  semanticTests.asmForLoop.for_loop_break.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.asmForLoop.for_loop_break.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.asmForLoop.for_loop_break.C.codes.
