...
Require semanticTests.asmForLoop.for_loop_continue.C.

Definition constructor_code : Code.t :=
  semanticTests.asmForLoop.for_loop_continue.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.asmForLoop.for_loop_continue.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.asmForLoop.for_loop_continue.C.codes.
