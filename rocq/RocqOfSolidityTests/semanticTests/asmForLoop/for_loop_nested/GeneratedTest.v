...
Require semanticTests.asmForLoop.for_loop_nested.C.

Definition constructor_code : Code.t :=
  semanticTests.asmForLoop.for_loop_nested.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.asmForLoop.for_loop_nested.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.asmForLoop.for_loop_nested.C.codes.
