...
Require semanticTests.salted_create.salted_create.A.
Require semanticTests.salted_create.salted_create.B.

Definition constructor_code : Code.t :=
  semanticTests.salted_create.salted_create.A.A.code.

Definition deployed_code : Code.t :=
  semanticTests.salted_create.salted_create.A.A.deployed.code.

Definition codes : list Code.t :=
  semanticTests.salted_create.salted_create.A.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "dea19231";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "9f4a394c";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
