...
Require semanticTests.accessor.accessor_for_state_variable.Lotto.

Definition constructor_code : Code.t :=
  semanticTests.accessor.accessor_for_state_variable.Lotto.Lotto.code.

Definition deployed_code : Code.t :=
  semanticTests.accessor.accessor_for_state_variable.Lotto.Lotto.deployed.code.

Definition codes : list Code.t :=
  semanticTests.accessor.accessor_for_state_variable.Lotto.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "1209b1f6";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
