...
Require semanticTests.freeFunctions.free_namesake_contract_function.C.

Definition constructor_code : Code.t :=
  semanticTests.freeFunctions.free_namesake_contract_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.freeFunctions.free_namesake_contract_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.freeFunctions.free_namesake_contract_function.C.codes.
