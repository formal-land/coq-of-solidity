...
Require semanticTests.freeFunctions.overloads.C.

Definition constructor_code : Code.t :=
  semanticTests.freeFunctions.overloads.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.freeFunctions.overloads.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.freeFunctions.overloads.C.codes.
