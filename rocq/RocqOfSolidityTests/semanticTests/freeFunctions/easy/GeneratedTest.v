...
Require semanticTests.freeFunctions.easy.C.

Definition constructor_code : Code.t :=
  semanticTests.freeFunctions.easy.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.freeFunctions.easy.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.freeFunctions.easy.C.codes.
