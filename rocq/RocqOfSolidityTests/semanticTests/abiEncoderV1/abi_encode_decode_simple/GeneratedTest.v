...
Require semanticTests.abiEncoderV1.abi_encode_decode_simple.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV1.abi_encode_decode_simple.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV1.abi_encode_decode_simple.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV1.abi_encode_decode_simple.C.codes.
