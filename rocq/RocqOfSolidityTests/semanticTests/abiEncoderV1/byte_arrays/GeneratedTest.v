...
Require semanticTests.abiEncoderV1.byte_arrays.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV1.byte_arrays.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV1.byte_arrays.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV1.byte_arrays.C.codes.
