...
Require semanticTests.abiEncoderV1.abi_encode_call.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV1.abi_encode_call.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV1.abi_encode_call.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV1.abi_encode_call.C.codes.
