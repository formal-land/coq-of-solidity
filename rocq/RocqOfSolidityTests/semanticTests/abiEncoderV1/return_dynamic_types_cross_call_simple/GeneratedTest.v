...
Require semanticTests.abiEncoderV1.return_dynamic_types_cross_call_simple.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV1.return_dynamic_types_cross_call_simple.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV1.return_dynamic_types_cross_call_simple.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV1.return_dynamic_types_cross_call_simple.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
