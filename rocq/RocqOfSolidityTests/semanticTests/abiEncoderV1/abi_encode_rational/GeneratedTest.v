...
Require semanticTests.abiEncoderV1.abi_encode_rational.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV1.abi_encode_rational.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV1.abi_encode_rational.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV1.abi_encode_rational.C.codes.
