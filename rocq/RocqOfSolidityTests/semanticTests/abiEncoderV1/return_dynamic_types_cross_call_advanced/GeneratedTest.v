...
Require semanticTests.abiEncoderV1.return_dynamic_types_cross_call_advanced.C.

Definition constructor_code : Code.t :=
  semanticTests.abiEncoderV1.return_dynamic_types_cross_call_advanced.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.abiEncoderV1.return_dynamic_types_cross_call_advanced.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.abiEncoderV1.return_dynamic_types_cross_call_advanced.C.codes.
