...
Require semanticTests.storageLayoutSpecifier.mapping_storage_end.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.mapping_storage_end.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.mapping_storage_end.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.mapping_storage_end.C.codes.
