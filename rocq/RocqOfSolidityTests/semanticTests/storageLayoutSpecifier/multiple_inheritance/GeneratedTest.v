...
Require semanticTests.storageLayoutSpecifier.multiple_inheritance.A.
Require semanticTests.storageLayoutSpecifier.multiple_inheritance.B.
Require semanticTests.storageLayoutSpecifier.multiple_inheritance.C.
Require semanticTests.storageLayoutSpecifier.multiple_inheritance.D.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.multiple_inheritance.D.D.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.multiple_inheritance.D.D.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.multiple_inheritance.D.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
...
Module Step5.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "c5d7802e";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
