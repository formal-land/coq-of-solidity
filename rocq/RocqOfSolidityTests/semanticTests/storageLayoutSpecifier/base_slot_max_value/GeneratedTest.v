...
Require semanticTests.storageLayoutSpecifier.base_slot_max_value.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.base_slot_max_value.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.base_slot_max_value.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.base_slot_max_value.C.codes.
