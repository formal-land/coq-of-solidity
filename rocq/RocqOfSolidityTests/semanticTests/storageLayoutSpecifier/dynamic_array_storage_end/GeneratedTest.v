...
Require semanticTests.storageLayoutSpecifier.dynamic_array_storage_end.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.dynamic_array_storage_end.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.dynamic_array_storage_end.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.dynamic_array_storage_end.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "e1c7392a";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "6901f668";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
