...
Require semanticTests.storageLayoutSpecifier.last_allowed_storage_slot.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.last_allowed_storage_slot.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.last_allowed_storage_slot.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.last_allowed_storage_slot.C.codes.
