...
Require semanticTests.storageLayoutSpecifier.state_variable_slot_offset.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.state_variable_slot_offset.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.state_variable_slot_offset.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.state_variable_slot_offset.C.codes.
