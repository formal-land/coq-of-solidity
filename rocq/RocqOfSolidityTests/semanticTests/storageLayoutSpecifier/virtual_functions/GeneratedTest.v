...
Require semanticTests.storageLayoutSpecifier.virtual_functions.A.
Require semanticTests.storageLayoutSpecifier.virtual_functions.B.
Require semanticTests.storageLayoutSpecifier.virtual_functions.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.virtual_functions.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.virtual_functions.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.virtual_functions.C.codes.
