...
Require semanticTests.storageLayoutSpecifier.state_variable_arithmetic_expression.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.state_variable_arithmetic_expression.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.state_variable_arithmetic_expression.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.state_variable_arithmetic_expression.C.codes.
