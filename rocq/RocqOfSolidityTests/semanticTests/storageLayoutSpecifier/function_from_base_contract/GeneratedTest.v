...
Require semanticTests.storageLayoutSpecifier.function_from_base_contract.A.
Require semanticTests.storageLayoutSpecifier.function_from_base_contract.B.
Require semanticTests.storageLayoutSpecifier.function_from_base_contract.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.function_from_base_contract.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.function_from_base_contract.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.function_from_base_contract.C.codes.
