...
Require semanticTests.storageLayoutSpecifier.getters.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.getters.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.getters.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.getters.C.codes.
