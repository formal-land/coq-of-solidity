...
Require semanticTests.storageLayoutSpecifier.state_variables_transient.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.state_variables_transient.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.state_variables_transient.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.state_variables_transient.C.codes.
