...
Require semanticTests.storageLayoutSpecifier.delete_transient_storage.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.delete_transient_storage.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.delete_transient_storage.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.delete_transient_storage.C.codes.
