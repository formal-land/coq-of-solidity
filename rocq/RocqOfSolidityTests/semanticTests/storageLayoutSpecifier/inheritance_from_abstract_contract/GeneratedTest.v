...
Require semanticTests.storageLayoutSpecifier.inheritance_from_abstract_contract.A.
Require semanticTests.storageLayoutSpecifier.inheritance_from_abstract_contract.C.

Definition constructor_code : Code.t :=
  semanticTests.storageLayoutSpecifier.inheritance_from_abstract_contract.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storageLayoutSpecifier.inheritance_from_abstract_contract.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storageLayoutSpecifier.inheritance_from_abstract_contract.C.codes.
