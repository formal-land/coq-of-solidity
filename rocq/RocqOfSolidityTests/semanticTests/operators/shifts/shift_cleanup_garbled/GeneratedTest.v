...
Require semanticTests.operators.shifts.shift_cleanup_garbled.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.shifts.shift_cleanup_garbled.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.shifts.shift_cleanup_garbled.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.shifts.shift_cleanup_garbled.C.codes.
