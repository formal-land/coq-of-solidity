...
Require semanticTests.operators.shifts.shift_cleanup.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.shifts.shift_cleanup.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.shifts.shift_cleanup.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.shifts.shift_cleanup.C.codes.
