...
Require semanticTests.operators.shifts.shift_left_uint8.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.shifts.shift_left_uint8.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.shifts.shift_left_uint8.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.shifts.shift_left_uint8.C.codes.
