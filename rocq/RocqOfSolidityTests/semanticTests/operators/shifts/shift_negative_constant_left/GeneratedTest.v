...
Require semanticTests.operators.shifts.shift_negative_constant_left.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.shifts.shift_negative_constant_left.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.shifts.shift_negative_constant_left.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.shifts.shift_negative_constant_left.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffbe00".
