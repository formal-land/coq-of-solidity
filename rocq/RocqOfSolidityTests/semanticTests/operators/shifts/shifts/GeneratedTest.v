...
Require semanticTests.operators.shifts.shifts.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.shifts.shifts.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.shifts.shifts.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.shifts.shifts.C.codes.
