...
Require semanticTests.operators.shifts.shift_constant_right_assignment.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.shifts.shift_constant_right_assignment.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.shifts.shift_constant_right_assignment.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.shifts.shift_constant_right_assignment.C.codes.
