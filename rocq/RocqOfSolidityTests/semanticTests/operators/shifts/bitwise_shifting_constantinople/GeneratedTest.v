...
Require semanticTests.operators.shifts.bitwise_shifting_constantinople.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.shifts.bitwise_shifting_constantinople.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.shifts.bitwise_shifting_constantinople.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.shifts.bitwise_shifting_constantinople.C.codes.
