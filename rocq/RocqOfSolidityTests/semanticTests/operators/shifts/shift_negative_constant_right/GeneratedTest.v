...
Require semanticTests.operators.shifts.shift_negative_constant_right.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.shifts.shift_negative_constant_right.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.shifts.shift_negative_constant_right.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.shifts.shift_negative_constant_right.C.codes.
