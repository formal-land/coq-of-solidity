...
Require semanticTests.operators.shifts.shift_left_larger_type.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.shifts.shift_left_larger_type.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.shifts.shift_left_larger_type.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.shifts.shift_left_larger_type.C.codes.
