...
Require semanticTests.operators.userDefined.multiple_operator_definitions_same_type_same_function_same_directive.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.userDefined.multiple_operator_definitions_same_type_same_function_same_directive.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.userDefined.multiple_operator_definitions_same_type_same_function_same_directive.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.userDefined.multiple_operator_definitions_same_type_same_function_same_directive.C.codes.
