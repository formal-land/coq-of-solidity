...
Require semanticTests.operators.userDefined.operator_definition_shadowing_builtin_keccak256.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.userDefined.operator_definition_shadowing_builtin_keccak256.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.userDefined.operator_definition_shadowing_builtin_keccak256.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.userDefined.operator_definition_shadowing_builtin_keccak256.C.codes.
