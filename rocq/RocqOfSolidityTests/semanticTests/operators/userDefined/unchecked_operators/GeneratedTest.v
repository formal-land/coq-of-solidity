...
Require semanticTests.operators.userDefined.unchecked_operators.D.

Definition constructor_code : Code.t :=
  semanticTests.operators.userDefined.unchecked_operators.D.D.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.userDefined.unchecked_operators.D.D.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.userDefined.unchecked_operators.D.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "28e31e7c";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "7b970bab";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
