...
Require semanticTests.operators.userDefined.consecutive_operator_invocations.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.userDefined.consecutive_operator_invocations.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.userDefined.consecutive_operator_invocations.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.userDefined.consecutive_operator_invocations.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "0000000000000000000000009999999999999999999999999999999999999999".
