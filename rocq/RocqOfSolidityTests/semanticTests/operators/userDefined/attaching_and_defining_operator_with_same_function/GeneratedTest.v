...
Require semanticTests.operators.userDefined.attaching_and_defining_operator_with_same_function.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.userDefined.attaching_and_defining_operator_with_same_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.userDefined.attaching_and_defining_operator_with_same_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.userDefined.attaching_and_defining_operator_with_same_function.C.codes.
