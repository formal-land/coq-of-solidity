...
Require semanticTests.operators.userDefined.checked_operators.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.userDefined.checked_operators.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.userDefined.checked_operators.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.userDefined.checked_operators.C.codes.
...
(* // testCheckedOperator() -> FAILUREhex"4e487b71", 0x11 *)
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "5d10d9fa";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
(* // testCheckedOperatorInUncheckedBlock() -> FAILUREhex"4e487b71", 0x11 *)
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "89c4fe17";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
