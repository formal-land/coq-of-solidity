...
Require semanticTests.operators.transient_storage_variable_increment_decrement.C.

Definition constructor_code : Code.t :=
  semanticTests.operators.transient_storage_variable_increment_decrement.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.operators.transient_storage_variable_increment_decrement.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.operators.transient_storage_variable_increment_decrement.C.codes.
