...
Require semanticTests.calldata.calldata_internal_function_pointer.C.

Definition constructor_code : Code.t :=
  semanticTests.calldata.calldata_internal_function_pointer.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.calldata.calldata_internal_function_pointer.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.calldata.calldata_internal_function_pointer.C.codes.
