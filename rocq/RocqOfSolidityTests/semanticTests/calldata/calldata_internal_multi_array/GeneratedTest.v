...
Require semanticTests.calldata.calldata_internal_multi_array.C.

Definition constructor_code : Code.t :=
  semanticTests.calldata.calldata_internal_multi_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.calldata.calldata_internal_multi_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.calldata.calldata_internal_multi_array.C.codes.
