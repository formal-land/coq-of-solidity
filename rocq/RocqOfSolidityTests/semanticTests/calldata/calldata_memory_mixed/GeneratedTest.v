...
Require semanticTests.calldata.calldata_memory_mixed.C.

Definition constructor_code : Code.t :=
  semanticTests.calldata.calldata_memory_mixed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.calldata.calldata_memory_mixed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.calldata.calldata_memory_mixed.C.codes.
