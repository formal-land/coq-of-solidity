...
Require semanticTests.calldata.calldata_internal_library.C.
Require semanticTests.calldata.calldata_internal_library.L.

Definition constructor_code : Code.t :=
  semanticTests.calldata.calldata_internal_library.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.calldata.calldata_internal_library.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.calldata.calldata_internal_library.C.codes.
