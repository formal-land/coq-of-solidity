...
Require semanticTests.uninitializedFunctionPointer.store2.InvalidTest.

Definition constructor_code : Code.t :=
  semanticTests.uninitializedFunctionPointer.store2.InvalidTest.InvalidTest.code.

Definition deployed_code : Code.t :=
  semanticTests.uninitializedFunctionPointer.store2.InvalidTest.InvalidTest.deployed.code.

Definition codes : list Code.t :=
  semanticTests.uninitializedFunctionPointer.store2.InvalidTest.codes.
