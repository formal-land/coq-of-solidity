...
Require semanticTests.c99_scoping_activation.test.

Definition constructor_code : Code.t :=
  semanticTests.c99_scoping_activation.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.c99_scoping_activation.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.c99_scoping_activation.test.codes.
