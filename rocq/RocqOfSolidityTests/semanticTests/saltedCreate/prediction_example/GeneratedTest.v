...
Require semanticTests.saltedCreate.prediction_example.C.
Require semanticTests.saltedCreate.prediction_example.D.

Definition constructor_code : Code.t :=
  semanticTests.saltedCreate.prediction_example.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.saltedCreate.prediction_example.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.saltedCreate.prediction_example.C.codes.
