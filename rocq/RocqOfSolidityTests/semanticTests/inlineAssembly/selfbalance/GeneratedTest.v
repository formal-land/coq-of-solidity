...
Require semanticTests.inlineAssembly.selfbalance.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.selfbalance.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.selfbalance.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.selfbalance.C.codes.
