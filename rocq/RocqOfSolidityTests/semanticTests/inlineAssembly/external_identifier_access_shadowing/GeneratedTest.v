...
Require semanticTests.inlineAssembly.external_identifier_access_shadowing.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.external_identifier_access_shadowing.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.external_identifier_access_shadowing.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.external_identifier_access_shadowing.C.codes.
