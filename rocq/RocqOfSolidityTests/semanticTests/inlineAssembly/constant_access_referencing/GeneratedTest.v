...
Require semanticTests.inlineAssembly.constant_access_referencing.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.constant_access_referencing.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.constant_access_referencing.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.constant_access_referencing.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
