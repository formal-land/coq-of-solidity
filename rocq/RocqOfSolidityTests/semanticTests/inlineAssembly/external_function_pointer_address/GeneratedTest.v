...
Require semanticTests.inlineAssembly.external_function_pointer_address.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.external_function_pointer_address.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.external_function_pointer_address.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.external_function_pointer_address.C.codes.
