...
Require semanticTests.inlineAssembly.inline_assembly_storage_access_local_var.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_storage_access_local_var.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_storage_access_local_var.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.inline_assembly_storage_access_local_var.C.codes.
