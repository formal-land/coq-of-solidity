...
Require semanticTests.inlineAssembly.inline_assembly_switch.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_switch.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_switch.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.inline_assembly_switch.C.codes.
