...
Require semanticTests.inlineAssembly.blobhash.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.blobhash.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.blobhash.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.blobhash.C.codes.
