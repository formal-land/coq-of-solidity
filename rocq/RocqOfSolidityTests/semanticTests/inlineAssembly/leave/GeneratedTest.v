...
Require semanticTests.inlineAssembly.leave.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.leave.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.leave.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.leave.C.codes.
