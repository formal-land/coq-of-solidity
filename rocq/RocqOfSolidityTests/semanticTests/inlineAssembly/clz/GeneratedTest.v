...
Require semanticTests.inlineAssembly.clz.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.clz.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.clz.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.clz.C.codes.
