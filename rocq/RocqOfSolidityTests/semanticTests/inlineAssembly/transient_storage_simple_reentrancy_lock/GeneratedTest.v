...
Require semanticTests.inlineAssembly.transient_storage_simple_reentrancy_lock.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_simple_reentrancy_lock.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_simple_reentrancy_lock.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.transient_storage_simple_reentrancy_lock.C.codes.
