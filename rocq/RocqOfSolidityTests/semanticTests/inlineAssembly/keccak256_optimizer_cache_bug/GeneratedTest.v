...
Require semanticTests.inlineAssembly.keccak256_optimizer_cache_bug.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.keccak256_optimizer_cache_bug.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.keccak256_optimizer_cache_bug.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.keccak256_optimizer_cache_bug.C.codes.
