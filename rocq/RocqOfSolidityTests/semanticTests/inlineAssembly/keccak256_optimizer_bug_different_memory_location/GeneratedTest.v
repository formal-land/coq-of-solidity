...
Require semanticTests.inlineAssembly.keccak256_optimizer_bug_different_memory_location.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.keccak256_optimizer_bug_different_memory_location.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.keccak256_optimizer_bug_different_memory_location.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.keccak256_optimizer_bug_different_memory_location.C.codes.
