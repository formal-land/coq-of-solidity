...
Require semanticTests.inlineAssembly.for_loop_continue.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.for_loop_continue.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.for_loop_continue.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.for_loop_continue.C.codes.
