...
Require semanticTests.inlineAssembly.mcopy_overlap.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.mcopy_overlap.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.mcopy_overlap.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.mcopy_overlap.C.codes.
