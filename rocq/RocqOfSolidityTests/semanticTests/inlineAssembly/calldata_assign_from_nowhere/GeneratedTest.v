...
Require semanticTests.inlineAssembly.calldata_assign_from_nowhere.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.calldata_assign_from_nowhere.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.calldata_assign_from_nowhere.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.calldata_assign_from_nowhere.C.codes.
