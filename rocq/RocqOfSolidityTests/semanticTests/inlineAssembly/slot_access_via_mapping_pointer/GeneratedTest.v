...
Require semanticTests.inlineAssembly.slot_access_via_mapping_pointer.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.slot_access_via_mapping_pointer.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.slot_access_via_mapping_pointer.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.slot_access_via_mapping_pointer.C.codes.
