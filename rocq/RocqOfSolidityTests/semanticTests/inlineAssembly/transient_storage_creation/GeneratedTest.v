...
Require semanticTests.inlineAssembly.transient_storage_creation.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_creation.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_creation.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.transient_storage_creation.C.codes.
