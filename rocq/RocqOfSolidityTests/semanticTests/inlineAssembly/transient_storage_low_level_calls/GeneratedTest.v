...
Require semanticTests.inlineAssembly.transient_storage_low_level_calls.C.
Require semanticTests.inlineAssembly.transient_storage_low_level_calls.D.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_low_level_calls.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_low_level_calls.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.transient_storage_low_level_calls.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "e1e36341";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "24819518";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step4.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "f20e871f";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
