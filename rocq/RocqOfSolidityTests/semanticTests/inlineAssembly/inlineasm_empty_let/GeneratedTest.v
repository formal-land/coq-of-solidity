...
Require semanticTests.inlineAssembly.inlineasm_empty_let.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.inlineasm_empty_let.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.inlineasm_empty_let.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.inlineasm_empty_let.C.codes.
