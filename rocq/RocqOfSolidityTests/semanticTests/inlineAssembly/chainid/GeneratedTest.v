...
Require semanticTests.inlineAssembly.chainid.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.chainid.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.chainid.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.chainid.C.codes.
