...
Require semanticTests.inlineAssembly.inline_assembly_storage_access_inside_function.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_storage_access_inside_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_storage_access_inside_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.inline_assembly_storage_access_inside_function.C.codes.
