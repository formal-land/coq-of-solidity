...
Require semanticTests.inlineAssembly.inline_assembly_in_modifiers.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_in_modifiers.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_in_modifiers.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.inline_assembly_in_modifiers.C.codes.
