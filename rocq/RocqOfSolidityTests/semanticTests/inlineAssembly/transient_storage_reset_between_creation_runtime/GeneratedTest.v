...
Require semanticTests.inlineAssembly.transient_storage_reset_between_creation_runtime.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_reset_between_creation_runtime.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_reset_between_creation_runtime.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.transient_storage_reset_between_creation_runtime.C.codes.
