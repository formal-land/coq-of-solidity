...
Require semanticTests.inlineAssembly.shadowing_local_function_opcode.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.shadowing_local_function_opcode.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.shadowing_local_function_opcode.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.shadowing_local_function_opcode.C.codes.
