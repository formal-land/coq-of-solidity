...
Require semanticTests.inlineAssembly.constant_access.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.constant_access.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.constant_access.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.constant_access.C.codes.
