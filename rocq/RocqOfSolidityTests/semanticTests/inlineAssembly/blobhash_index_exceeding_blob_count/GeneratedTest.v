...
Require semanticTests.inlineAssembly.blobhash_index_exceeding_blob_count.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.blobhash_index_exceeding_blob_count.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.blobhash_index_exceeding_blob_count.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.blobhash_index_exceeding_blob_count.C.codes.
