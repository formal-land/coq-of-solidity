...
Require semanticTests.inlineAssembly.inline_assembly_storage_access_via_pointer.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_storage_access_via_pointer.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_storage_access_via_pointer.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.inline_assembly_storage_access_via_pointer.C.codes.
...
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "509d19e5";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step4.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "4e69e7d8";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
