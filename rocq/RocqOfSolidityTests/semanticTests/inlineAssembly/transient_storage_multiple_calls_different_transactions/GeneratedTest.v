...
Require semanticTests.inlineAssembly.transient_storage_multiple_calls_different_transactions.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_multiple_calls_different_transactions.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.transient_storage_multiple_calls_different_transactions.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.transient_storage_multiple_calls_different_transactions.C.codes.
