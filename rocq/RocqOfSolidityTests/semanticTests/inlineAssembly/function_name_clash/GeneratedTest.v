...
Require semanticTests.inlineAssembly.function_name_clash.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.function_name_clash.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.function_name_clash.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.function_name_clash.C.codes.
