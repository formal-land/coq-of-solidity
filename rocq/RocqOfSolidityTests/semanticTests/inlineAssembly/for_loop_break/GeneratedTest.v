...
Require semanticTests.inlineAssembly.for_loop_break.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.for_loop_break.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.for_loop_break.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.for_loop_break.C.codes.
