...
Require semanticTests.inlineAssembly.tstore_hidden_staticcall.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.tstore_hidden_staticcall.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.tstore_hidden_staticcall.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.tstore_hidden_staticcall.C.codes.
