...
Require semanticTests.inlineAssembly.optimize_memory_store_multi_block.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.optimize_memory_store_multi_block.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.optimize_memory_store_multi_block.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.optimize_memory_store_multi_block.C.codes.
