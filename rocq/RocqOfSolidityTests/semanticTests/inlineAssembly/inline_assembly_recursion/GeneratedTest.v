...
Require semanticTests.inlineAssembly.inline_assembly_recursion.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_recursion.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.inline_assembly_recursion.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.inline_assembly_recursion.C.codes.
