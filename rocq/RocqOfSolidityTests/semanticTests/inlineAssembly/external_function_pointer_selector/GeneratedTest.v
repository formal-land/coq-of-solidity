...
Require semanticTests.inlineAssembly.external_function_pointer_selector.C.

Definition constructor_code : Code.t :=
  semanticTests.inlineAssembly.external_function_pointer_selector.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.inlineAssembly.external_function_pointer_selector.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.inlineAssembly.external_function_pointer_selector.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "fc1249ee";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "00000000000000000000000000000000000000000000000000000000e16b4a9b".
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "eda107c0";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
