...
Require semanticTests.functionTypes.mapping_of_functions.Flow.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.mapping_of_functions.Flow.Flow.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.mapping_of_functions.Flow.Flow.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.mapping_of_functions.Flow.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "0b93381b";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
