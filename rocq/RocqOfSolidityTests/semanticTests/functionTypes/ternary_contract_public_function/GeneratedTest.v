...
Require semanticTests.functionTypes.ternary_contract_public_function.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.ternary_contract_public_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.ternary_contract_public_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.ternary_contract_public_function.C.codes.
