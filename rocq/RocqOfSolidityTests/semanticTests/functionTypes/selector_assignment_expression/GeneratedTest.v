...
Require semanticTests.functionTypes.selector_assignment_expression.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.selector_assignment_expression.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.selector_assignment_expression.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.selector_assignment_expression.C.codes.
