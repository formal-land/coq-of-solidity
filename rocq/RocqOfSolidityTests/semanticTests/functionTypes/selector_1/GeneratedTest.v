...
Require semanticTests.functionTypes.selector_1.B.
Require semanticTests.functionTypes.selector_1.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.selector_1.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.selector_1.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.selector_1.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
