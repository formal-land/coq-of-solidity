...
Require semanticTests.functionTypes.stack_height_check_on_adding_gas_variable_to_function.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.stack_height_check_on_adding_gas_variable_to_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.stack_height_check_on_adding_gas_variable_to_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.stack_height_check_on_adding_gas_variable_to_function.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "4eaf8b7c";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
