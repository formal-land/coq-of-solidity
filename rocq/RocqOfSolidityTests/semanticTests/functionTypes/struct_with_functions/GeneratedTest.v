...
Require semanticTests.functionTypes.struct_with_functions.Flow.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.struct_with_functions.Flow.Flow.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.struct_with_functions.Flow.Flow.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.struct_with_functions.Flow.codes.
