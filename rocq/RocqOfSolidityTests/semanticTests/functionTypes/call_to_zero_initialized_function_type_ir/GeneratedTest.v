...
Require semanticTests.functionTypes.call_to_zero_initialized_function_type_ir.C.
Require semanticTests.functionTypes.call_to_zero_initialized_function_type_ir.Other.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.call_to_zero_initialized_function_type_ir.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.call_to_zero_initialized_function_type_ir.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.call_to_zero_initialized_function_type_ir.C.codes.
