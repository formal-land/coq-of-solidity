...
Require semanticTests.functionTypes.store_function.C.
Require semanticTests.functionTypes.store_function.Other.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.store_function.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.store_function.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.store_function.C.codes.
