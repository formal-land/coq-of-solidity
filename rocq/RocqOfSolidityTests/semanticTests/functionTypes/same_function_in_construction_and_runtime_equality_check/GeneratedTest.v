...
Require semanticTests.functionTypes.same_function_in_construction_and_runtime_equality_check.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.same_function_in_construction_and_runtime_equality_check.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.same_function_in_construction_and_runtime_equality_check.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.same_function_in_construction_and_runtime_equality_check.C.codes.
