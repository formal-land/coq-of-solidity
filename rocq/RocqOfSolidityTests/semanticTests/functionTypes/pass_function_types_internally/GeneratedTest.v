...
Require semanticTests.functionTypes.pass_function_types_internally.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.pass_function_types_internally.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.pass_function_types_internally.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.pass_function_types_internally.C.codes.
