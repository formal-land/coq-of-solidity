...
Require semanticTests.functionTypes.comparison_operator_for_external_function_cleans_dirty_bits.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.comparison_operator_for_external_function_cleans_dirty_bits.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.comparison_operator_for_external_function_cleans_dirty_bits.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.comparison_operator_for_external_function_cleans_dirty_bits.C.codes.
...
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "1d492a89";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
