...
Require semanticTests.functionTypes.selector_ternary.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.selector_ternary.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.selector_ternary.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.selector_ternary.C.codes.
