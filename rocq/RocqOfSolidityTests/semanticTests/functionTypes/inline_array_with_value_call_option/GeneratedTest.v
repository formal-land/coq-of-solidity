...
Require semanticTests.functionTypes.inline_array_with_value_call_option.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.inline_array_with_value_call_option.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.inline_array_with_value_call_option.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.inline_array_with_value_call_option.C.codes.
