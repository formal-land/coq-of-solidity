...
Require semanticTests.functionTypes.selector_expression_side_effect.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.selector_expression_side_effect.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.selector_expression_side_effect.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.selector_expression_side_effect.C.codes.
