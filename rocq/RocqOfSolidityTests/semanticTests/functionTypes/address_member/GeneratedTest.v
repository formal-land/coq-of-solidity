...
Require semanticTests.functionTypes.address_member.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.address_member.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.address_member.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.address_member.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "00000000000000000000000000000000000000000000000000000000000012340000000000000000000000000000000000000000000000000000000000001234".
