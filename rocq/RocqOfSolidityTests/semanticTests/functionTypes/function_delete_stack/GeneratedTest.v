...
Require semanticTests.functionTypes.function_delete_stack.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.function_delete_stack.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.function_delete_stack.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.function_delete_stack.C.codes.
