...
Require semanticTests.functionTypes.external_functions_with_calldata_args_assigned_to_function_pointers_with_memory_type.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.external_functions_with_calldata_args_assigned_to_function_pointers_with_memory_type.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.external_functions_with_calldata_args_assigned_to_function_pointers_with_memory_type.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.external_functions_with_calldata_args_assigned_to_function_pointers_with_memory_type.C.codes.
