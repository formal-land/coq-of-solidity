...
Require semanticTests.functionTypes.duplicated_function_definition_with_same_id_in_internal_dispatcher.C.

Definition constructor_code : Code.t :=
  semanticTests.functionTypes.duplicated_function_definition_with_same_id_in_internal_dispatcher.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.functionTypes.duplicated_function_definition_with_same_id_in_internal_dispatcher.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.functionTypes.duplicated_function_definition_with_same_id_in_internal_dispatcher.C.codes.
