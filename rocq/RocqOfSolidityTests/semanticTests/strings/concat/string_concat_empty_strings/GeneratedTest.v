...
Require semanticTests.strings.concat.string_concat_empty_strings.C.

Definition constructor_code : Code.t :=
  semanticTests.strings.concat.string_concat_empty_strings.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.strings.concat.string_concat_empty_strings.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.strings.concat.string_concat_empty_strings.C.codes.
