...
Require semanticTests.strings.string_escapes.test.

Definition constructor_code : Code.t :=
  semanticTests.strings.string_escapes.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.strings.string_escapes.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.strings.string_escapes.test.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "090a0d27225c0000000000000000000000000000000000000000000000000000".
