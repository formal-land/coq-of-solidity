...
Require semanticTests.viaYul.assert.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.assert.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.assert.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.assert.C.codes.
