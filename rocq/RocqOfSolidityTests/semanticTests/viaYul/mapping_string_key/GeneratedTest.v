...
Require semanticTests.viaYul.mapping_string_key.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.mapping_string_key.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.mapping_string_key.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.mapping_string_key.C.codes.
