...
Require semanticTests.viaYul.storage.dirty_storage_static_array.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.storage.dirty_storage_static_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.storage.dirty_storage_static_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.storage.dirty_storage_static_array.C.codes.
