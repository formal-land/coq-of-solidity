...
Require semanticTests.viaYul.storage.dirty_storage_struct.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.storage.dirty_storage_struct.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.storage.dirty_storage_struct.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.storage.dirty_storage_struct.C.codes.
