...
Require semanticTests.viaYul.storage.dirty_storage_bytes_long.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.storage.dirty_storage_bytes_long.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.storage.dirty_storage_bytes_long.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.storage.dirty_storage_bytes_long.C.codes.
