...
Require semanticTests.viaYul.local_bool_assignment.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.local_bool_assignment.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.local_bool_assignment.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.local_bool_assignment.C.codes.
