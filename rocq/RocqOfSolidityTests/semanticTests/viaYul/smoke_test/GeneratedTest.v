...
Require semanticTests.viaYul.smoke_test.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.smoke_test.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.smoke_test.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.smoke_test.C.codes.
