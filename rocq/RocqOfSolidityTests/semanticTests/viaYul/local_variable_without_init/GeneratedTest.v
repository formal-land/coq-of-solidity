...
Require semanticTests.viaYul.local_variable_without_init.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.local_variable_without_init.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.local_variable_without_init.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.local_variable_without_init.C.codes.
