...
Require semanticTests.viaYul.define_tuple_from_function_call.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.define_tuple_from_function_call.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.define_tuple_from_function_call.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.define_tuple_from_function_call.C.codes.
