...
Require semanticTests.viaYul.exp_literals.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.exp_literals.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.exp_literals.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.exp_literals.C.codes.
