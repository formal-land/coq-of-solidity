...
Require semanticTests.viaYul.mapping_enum_key_getter.test.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.mapping_enum_key_getter.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.mapping_enum_key_getter.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.mapping_enum_key_getter.test.codes.
