...
Require semanticTests.viaYul.return.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.return.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.return.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.return.C.codes.
