...
Require semanticTests.viaYul.delete.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.delete.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.delete.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.delete.C.codes.
...
(* // call_deleted_internal_func() -> FAILUREhex"4e487b71", 0x51 *)
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "6393ab24";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "b92b264e";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
