...
Require semanticTests.viaYul.msg_sender.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.msg_sender.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.msg_sender.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.msg_sender.C.codes.
