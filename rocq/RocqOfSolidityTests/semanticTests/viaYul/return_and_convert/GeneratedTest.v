...
Require semanticTests.viaYul.return_and_convert.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.return_and_convert.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.return_and_convert.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.return_and_convert.C.codes.
