...
Require semanticTests.viaYul.simple_inline_asm.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.simple_inline_asm.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.simple_inline_asm.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.simple_inline_asm.C.codes.
