...
Require semanticTests.viaYul.dirty_memory_struct.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.dirty_memory_struct.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.dirty_memory_struct.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.dirty_memory_struct.C.codes.
