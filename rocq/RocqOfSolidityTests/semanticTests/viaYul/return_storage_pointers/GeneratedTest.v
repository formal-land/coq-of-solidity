...
Require semanticTests.viaYul.return_storage_pointers.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.return_storage_pointers.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.return_storage_pointers.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.return_storage_pointers.C.codes.
