...
Require semanticTests.viaYul.dirty_memory_static_array.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.dirty_memory_static_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.dirty_memory_static_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.dirty_memory_static_array.C.codes.
