...
Require semanticTests.viaYul.loops.break.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.loops.break.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.loops.break.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.loops.break.C.codes.
