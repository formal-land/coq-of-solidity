...
Require semanticTests.viaYul.loops.continue.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.loops.continue.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.loops.continue.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.loops.continue.C.codes.
