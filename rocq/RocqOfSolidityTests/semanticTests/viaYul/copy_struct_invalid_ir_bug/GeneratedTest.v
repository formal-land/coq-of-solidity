...
Require semanticTests.viaYul.copy_struct_invalid_ir_bug.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.copy_struct_invalid_ir_bug.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.copy_struct_invalid_ir_bug.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.copy_struct_invalid_ir_bug.C.codes.
