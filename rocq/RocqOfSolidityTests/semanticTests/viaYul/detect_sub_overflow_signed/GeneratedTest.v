...
Require semanticTests.viaYul.detect_sub_overflow_signed.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.detect_sub_overflow_signed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.detect_sub_overflow_signed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.detect_sub_overflow_signed.C.codes.
