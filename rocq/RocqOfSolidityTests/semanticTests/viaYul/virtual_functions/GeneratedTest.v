...
Require semanticTests.viaYul.virtual_functions.C.
Require semanticTests.viaYul.virtual_functions.X.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.virtual_functions.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.virtual_functions.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.virtual_functions.C.codes.
