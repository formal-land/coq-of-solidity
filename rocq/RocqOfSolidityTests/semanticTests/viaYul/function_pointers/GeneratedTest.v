...
Require semanticTests.viaYul.function_pointers.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.function_pointers.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.function_pointers.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.function_pointers.C.codes.
...
(* // h2() -> FAILUREhex"4e487b71", 0x51 *)
Module Step3.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "5092f2ec";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
...
Module Step4.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "a7f81e6a";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
