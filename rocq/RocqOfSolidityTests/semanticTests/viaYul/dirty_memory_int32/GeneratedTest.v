...
Require semanticTests.viaYul.dirty_memory_int32.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.dirty_memory_int32.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.dirty_memory_int32.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.dirty_memory_int32.C.codes.
