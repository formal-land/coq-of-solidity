...
Require semanticTests.viaYul.conversion.implicit_cast_local_assignment.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.conversion.implicit_cast_local_assignment.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.conversion.implicit_cast_local_assignment.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.conversion.implicit_cast_local_assignment.C.codes.
