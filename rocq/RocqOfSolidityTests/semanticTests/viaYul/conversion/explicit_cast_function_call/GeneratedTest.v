...
Require semanticTests.viaYul.conversion.explicit_cast_function_call.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.conversion.explicit_cast_function_call.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.conversion.explicit_cast_function_call.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.conversion.explicit_cast_function_call.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "1234567800000000000000000000000000000000000000000000000000000000".
