...
Require semanticTests.viaYul.assert_and_require.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.assert_and_require.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.assert_and_require.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.assert_and_require.C.codes.
...
(* // f(bool): false -> FAILUREhex"4e487b71", 0x01 *)
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
