...
Require semanticTests.viaYul.empty_return_corrupted_free_memory_pointer.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.empty_return_corrupted_free_memory_pointer.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.empty_return_corrupted_free_memory_pointer.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.empty_return_corrupted_free_memory_pointer.C.codes.
