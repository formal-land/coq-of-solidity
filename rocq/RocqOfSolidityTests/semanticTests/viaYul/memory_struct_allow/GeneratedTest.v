...
Require semanticTests.viaYul.memory_struct_allow.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.memory_struct_allow.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.memory_struct_allow.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.memory_struct_allow.C.codes.
