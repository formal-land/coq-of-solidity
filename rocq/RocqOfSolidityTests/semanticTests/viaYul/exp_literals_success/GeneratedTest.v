...
Require semanticTests.viaYul.exp_literals_success.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.exp_literals_success.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.exp_literals_success.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.exp_literals_success.C.codes.
