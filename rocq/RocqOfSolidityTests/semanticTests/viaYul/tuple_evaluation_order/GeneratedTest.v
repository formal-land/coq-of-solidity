...
Require semanticTests.viaYul.tuple_evaluation_order.C.

Definition constructor_code : Code.t :=
  semanticTests.viaYul.tuple_evaluation_order.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.viaYul.tuple_evaluation_order.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.viaYul.tuple_evaluation_order.C.codes.
