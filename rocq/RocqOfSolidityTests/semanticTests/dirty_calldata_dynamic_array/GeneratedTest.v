...
Require semanticTests.dirty_calldata_dynamic_array.C.

Definition constructor_code : Code.t :=
  semanticTests.dirty_calldata_dynamic_array.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.dirty_calldata_dynamic_array.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.dirty_calldata_dynamic_array.C.codes.
