...
Require semanticTests.emit_three_identical_events.C.

Definition constructor_code : Code.t :=
  semanticTests.emit_three_identical_events.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.emit_three_identical_events.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.emit_three_identical_events.C.codes.
