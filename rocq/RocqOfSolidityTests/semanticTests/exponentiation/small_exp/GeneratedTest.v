...
Require semanticTests.exponentiation.small_exp.test.

Definition constructor_code : Code.t :=
  semanticTests.exponentiation.small_exp.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.exponentiation.small_exp.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.exponentiation.small_exp.test.codes.
