...
Require semanticTests.storage.simple_accessor.test.

Definition constructor_code : Code.t :=
  semanticTests.storage.simple_accessor.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.storage.simple_accessor.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storage.simple_accessor.test.codes.
