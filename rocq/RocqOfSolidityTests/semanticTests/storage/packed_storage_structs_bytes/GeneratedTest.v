...
Require semanticTests.storage.packed_storage_structs_bytes.C.

Definition constructor_code : Code.t :=
  semanticTests.storage.packed_storage_structs_bytes.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storage.packed_storage_structs_bytes.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storage.packed_storage_structs_bytes.C.codes.
