...
Require semanticTests.storage.packed_storage_structs_uint.C.

Definition constructor_code : Code.t :=
  semanticTests.storage.packed_storage_structs_uint.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storage.packed_storage_structs_uint.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storage.packed_storage_structs_uint.C.codes.
