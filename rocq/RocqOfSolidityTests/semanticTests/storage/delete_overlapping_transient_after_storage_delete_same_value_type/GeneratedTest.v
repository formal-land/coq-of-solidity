...
Require semanticTests.storage.delete_overlapping_transient_after_storage_delete_same_value_type.C.

Definition constructor_code : Code.t :=
  semanticTests.storage.delete_overlapping_transient_after_storage_delete_same_value_type.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storage.delete_overlapping_transient_after_storage_delete_same_value_type.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storage.delete_overlapping_transient_after_storage_delete_same_value_type.C.codes.
