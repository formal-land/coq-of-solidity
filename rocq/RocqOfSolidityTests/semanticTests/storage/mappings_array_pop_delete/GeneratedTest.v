...
Require semanticTests.storage.mappings_array_pop_delete.C.

Definition constructor_code : Code.t :=
  semanticTests.storage.mappings_array_pop_delete.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storage.mappings_array_pop_delete.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storage.mappings_array_pop_delete.C.codes.
