...
Require semanticTests.storage.packed_storage_signed.C.

Definition constructor_code : Code.t :=
  semanticTests.storage.packed_storage_signed.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storage.packed_storage_signed.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storage.packed_storage_signed.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
