...
Require semanticTests.storage.packed_storage_overflow.C.

Definition constructor_code : Code.t :=
  semanticTests.storage.packed_storage_overflow.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storage.packed_storage_overflow.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storage.packed_storage_overflow.C.codes.
...
Module Step1.
  ...
  Definition expected_output : list Z :=
    Memory.hex_string_as_bytes "".
