...
Module Test.
  Definition code : Code.t := {|
    Code.name := "Test_13";
    Code.hex_name := 0x546573745f313300000000000000000000000000000000000000000000000000;
    Code.functions :=
      [
            ...
            do! ltac:(M.monadic (
              M.declare (|
                ...
                Some (M.call_function (|
                  "datasize",
                  [
                    [Literal.string 0x546573745f31335f6465706c6f79656400000000000000000000000000000000]
                  ]
                |))
              |)
            )) in
  ...
  Module deployed.
    Definition code : Code.t := {|
      ...
      Code.hex_name := 0x546573745f31335f6465706c6f79656400000000000000000000000000000000;
      Code.functions :=
        [
