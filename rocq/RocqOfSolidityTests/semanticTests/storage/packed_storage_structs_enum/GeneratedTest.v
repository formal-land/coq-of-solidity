...
Require semanticTests.storage.packed_storage_structs_enum.C.

Definition constructor_code : Code.t :=
  semanticTests.storage.packed_storage_structs_enum.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.storage.packed_storage_structs_enum.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.storage.packed_storage_structs_enum.C.codes.
