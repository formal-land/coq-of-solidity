...
Require semanticTests.statements.do_while_loop_continue.test.

Definition constructor_code : Code.t :=
  semanticTests.statements.do_while_loop_continue.test.test.code.

Definition deployed_code : Code.t :=
  semanticTests.statements.do_while_loop_continue.test.test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.statements.do_while_loop_continue.test.codes.
