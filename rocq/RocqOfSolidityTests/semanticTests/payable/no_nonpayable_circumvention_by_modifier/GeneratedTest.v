...
Require semanticTests.payable.no_nonpayable_circumvention_by_modifier.C.

Definition constructor_code : Code.t :=
  semanticTests.payable.no_nonpayable_circumvention_by_modifier.C.C.code.

Definition deployed_code : Code.t :=
  semanticTests.payable.no_nonpayable_circumvention_by_modifier.C.C.deployed.code.

Definition codes : list Code.t :=
  semanticTests.payable.no_nonpayable_circumvention_by_modifier.C.codes.
