...
Module Lisa.
  Definition code : Code.t := {|
    Code.name := "Lisa_92";
    Code.hex_name := 0x4c6973615f393200000000000000000000000000000000000000000000000000;
    Code.functions :=
      [
            ...
            do! ltac:(M.monadic (
              M.declare (|
                ...
                Some (M.call_function (|
                  "datasize",
                  [
                    [Literal.string 0x4c6973615f39325f6465706c6f79656400000000000000000000000000000000]
                  ]
                |))
              |)
            )) in
  ...
  Module deployed.
    Definition code : Code.t := {|
      Code.name := "Lisa_92_deployed";
      Code.hex_name := 0x4c6973615f39325f6465706c6f79656400000000000000000000000000000000;
      Code.functions :=
        [
