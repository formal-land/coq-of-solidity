...
Module Homer.
  Definition code : Code.t := {|
    Code.name := "Homer_68";
    Code.hex_name := 0x486f6d65725f3638000000000000000000000000000000000000000000000000;
    Code.functions :=
      [
            ...
            do! ltac:(M.monadic (
              M.declare (|
                ...
                Some (M.call_function (|
                  "datasize",
                  [
                    [Literal.string 0x486f6d65725f36385f6465706c6f796564000000000000000000000000000000]
                  ]
                |))
              |)
            )) in
  ...
  Module deployed.
    Definition code : Code.t := {|
      Code.name := "Homer_68_deployed";
      Code.hex_name := 0x486f6d65725f36385f6465706c6f796564000000000000000000000000000000;
      Code.functions :=
        [
