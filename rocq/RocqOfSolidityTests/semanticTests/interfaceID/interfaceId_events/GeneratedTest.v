...
Require semanticTests.interfaceID.interfaceId_events.HelloWorld.
Require semanticTests.interfaceID.interfaceId_events.HelloWorldWithEvent.
Require semanticTests.interfaceID.interfaceId_events.Test.

Definition constructor_code : Code.t :=
  semanticTests.interfaceID.interfaceId_events.Test.Test.code.

Definition deployed_code : Code.t :=
  semanticTests.interfaceID.interfaceId_events.Test.Test.deployed.code.

Definition codes : list Code.t :=
  semanticTests.interfaceID.interfaceId_events.Test.codes.
...
Module Step2.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
    Environment.calldata := Memory.hex_string_as_bytes "3232b21e";
    Environment.address := 0xc06afe3a8444fc0004668591e8306bfb9968e79e;
    Environment.code_name := deployed_code.(Code.hex_name);
  |}.
